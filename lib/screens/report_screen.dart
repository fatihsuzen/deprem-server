...
class _ReportScreenState extends State<ReportScreen> {
  ...
  final List<Map<String, dynamic>> intensityLevels = [
    {
      'level': 2,
      'title': 'Sadece hassas kişiler tarafından hissedilir',
      'description': 'II - Zar zor algılanan',
      'color': Colors.blue.shade100,
      'textColor': Colors.blue.shade800,
    },
    {
      'level': 3,
      'title': 'Evde oturan kişiler tarafından hissedilir',
      'description': 'III - Geçen bir kamyona benzer titreşimler',
      'color': Colors.lightBlue.shade100,
      'textColor': Colors.lightBlue.shade800,
    },
    {
      'level': 4,
      'title': 'Çoğu kişi tarafından hissedilir, uyuyanlar uyanabilir',
      'description':
    ...
    {
      'level': 5,
      'title': 'Herkes tarafından hissedilir, küçük eşyalar düşer',
      'description': 'V - Raflardan düşen nesneler',
      'color': Colors.green.shade200,
      'textColor': Colors.green.shade800,
    },
    {
      'level': 6,
      'title': 'Mobilyalar hareket eder, duvarlar çatlar',
      'description': 'VI - Binalarda ve kırık camlarda küçük çatlaklar',
      'color': Colors.yellow.shade300,
      'textColor': Colors.yellow.shade800,
    },
    {
      'level': 7,
      'title': 'Ayakta durmak zor, yapılarda önemli hasarlar',
      'description': 'VII - Binalarda hasarlar, ayakta durmakta zorluk',
      'color': Colors.orange.shade400,
      'textColor': Colors.orange.shade800,
    },
    {
      'level': 8,
      'title': 'Yapısal hasarlar, bazı binalar çökebilir',
      'description': 'VIII - Binalarda bariz hasarlar ve kısmi çökmeler',
    ...
    {
      'level': 10,
      'title': 'Tüm yapılar yıkılır, büyük çapta tahribat',
      'description': 'X - Bütün binalar çöktü',
      'color': Colors.red.shade800,
      'textColor': Colors.white,
    },
    {
      'level': 11,
      'title': 'Toprak yarılır, coğrafi değişiklikler oluşur',
      'description': 'XI - Zeminde büyük yarıklar',
      'color': Colors.red.shade900,
      'textColor': Colors.white,
    },
    {
      'level': 12,
      'title': 'Topografya değişir, nehirler yön değiştirir',
      'description': 'XII - Tamamen yıkıcı',
      'color': Colors.black,
      'textColor': Colors.white,
    },
  ];
