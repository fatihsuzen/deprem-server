...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i5, int i6) {
        doOnApplyWindowInsets(view, attributeSet, i5, i6, (OnApplyWindowInsetsListener) null);
    }

    public static float dpToPx(@NonNull Context context, @Dimension(unit = 0) int i5) {
        return TypedValue.applyDimension(1, (float) i5, context.getResources().getDisplayMetrics());
    }
    ...
    public static void requestFocusAndShowKeyboard(@NonNull View view, boolean z4) {
        view.requestFocus();
        view.post(new f(view, z4));
    }
