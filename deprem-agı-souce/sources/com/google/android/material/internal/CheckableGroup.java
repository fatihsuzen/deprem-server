...
public class CheckableGroup<T extends MaterialCheckable<T>> {
    ...
    public void addCheckable(T t5) {
        ...
        t5.setInternalOnCheckedChangeListener(new MaterialCheckable.OnCheckedChangeListener<T>() {
    ...
    public void check(@IdRes int i5) {
        MaterialCheckable materialCheckable = (MaterialCheckable) this.checkables.get(Integer.valueOf(i5));
    ...
    public void removeCheckable(T t5) {
        t5.setInternalOnCheckedChangeListener((MaterialCheckable.OnCheckedChangeListener) null);
