...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i5) {
        this(context, i5, (DatePickerDialog.OnDateSetListener) null, -1, -1, -1);
    }
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i5, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i6, int i7, int i8) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context2, (AttributeSet) null, DEF_STYLE_ATTR, i9);
        materialShapeDrawable.setFillColor(ColorStateList.valueOf(resolveOrThrow));
        Rect dialogBackgroundInsets = MaterialDialogs.getDialogBackgroundInsets(context2, DEF_STYLE_ATTR, i9);
