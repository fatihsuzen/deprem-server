...
public class HctSolver {
    ...
    static double[] bisectToLimit(double d5, double d6) {
        ...
        for (int i7 = 0; i7 < 3; i7++) {
            ...
            if (d7 != d8) {
                if (d7 < d8) {
                    i6 = criticalPlaneBelow(trueDelinearized(d7));
                    i5 = criticalPlaneAbove(trueDelinearized(dArr2[i7]));
                } else {
                    i6 = criticalPlaneAbove(trueDelinearized(d7));
                    i5 = criticalPlaneBelow(trueDelinearized(dArr2[i7]));
                }
                double d9 = hueOf;
                int i8 = i6;
                int i9 = i5;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x003e, code lost:
        if (areInCyclicOrder(r10, r12, r14) != false) goto L_0x0040;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static double[][] bisectToSegment(double r20, double r22) {
        /*
            r0 = 3
        ...
        L_0x0036:
            ...
            boolean r17 = areInCyclicOrder(r10, r12, r14)
            r18 = r14
        ...
        L_0x0047:
            ...
            goto L_0x0040
        L_0x004a:
            boolean r9 = areInCyclicOrder(r10, r12, r14)
            r12 = r14
    ...
    static double chromaticAdaptation(double d5) {
        ...
        return ((((double) MathUtils.signum(d5)) * 400.0d) * pow) / (pow + 27.13d);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0174, code lost:
        if (r3[0] > 100.01d) goto L_0x0188;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x017a, code lost:
        if (r3[1] > 100.01d) goto L_0x0188;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0180, code lost:
        if (r3[2] <= 100.01d) goto L_0x0183;
     */
    ...
    static double inverseChromaticAdaptation(double d5) {
        ...
        return ((double) MathUtils.signum(d5)) * Math.pow(Math.max(0.0d, (27.13d * abs) / (400.0d - abs)), 2.380952380952381d);
    }
