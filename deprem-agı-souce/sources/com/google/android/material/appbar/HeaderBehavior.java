...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    /* access modifiers changed from: package-private */
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v5, int i5, int i6, float f5) {
        ...
        if (this.scroller.computeScrollOffset()) {
            FlingRunnable flingRunnable2 = new FlingRunnable(coordinatorLayout, v5);
            this.flingRunnable = flingRunnable2;
            v5.postOnAnimation(flingRunnable2);
            return true;
        }
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v5, @NonNull MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (!canDragView(v5) || !coordinatorLayout.isPointInChildBounds(v5, x4, y5)) {
                z4 = false;
            } else {
                z4 = true;
            }
    ...
    /* access modifiers changed from: package-private */
    public final int scroll(CoordinatorLayout coordinatorLayout, V v5, int i5, int i6, int i7) {
    ...
    /* access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v5, int i5, int i6, int i7) {
        int clamp;
