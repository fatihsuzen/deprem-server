...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    private void updateShapeMask(int i5, int i6) {
        this.destination.set((float) getPaddingLeft(), (float) getPaddingTop(), (float) (i5 - getPaddingRight()), (float) (i6 - getPaddingBottom()));
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, (float) i5, (float) i6);
    ...
    public void setStrokeWidthResource(@DimenRes int i5) {
        setStrokeWidth((float) getResources().getDimensionPixelSize(i5));
    }
