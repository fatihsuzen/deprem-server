...
public interface CircularRevealWidget extends CircularRevealHelper.Delegate {
    ...
    public static class CircularRevealEvaluator implements TypeEvaluator<RevealInfo> {
        ...
        @NonNull
        public RevealInfo evaluate(float f5, @NonNull RevealInfo revealInfo2, @NonNull RevealInfo revealInfo3) {
            this.revealInfo.set(MathUtils.lerp(revealInfo2.centerX, revealInfo3.centerX, f5), MathUtils.lerp(revealInfo2.centerY, revealInfo3.centerY, f5), MathUtils.lerp(revealInfo2.radius, revealInfo3.radius, f5));
