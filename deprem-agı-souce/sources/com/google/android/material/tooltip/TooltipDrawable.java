...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i5, @StyleRes int i6) {
    ...
    @NonNull
    public static TooltipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet, @AttrRes int i5, @StyleRes int i6) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context2, attributeSet, i5, i6);
        tooltipDrawable.loadFromAttributes(attributeSet, i5, i6);
        return tooltipDrawable;
    }

    private EdgeTreatment createMarkerEdge() {
        float width = (float) ((((double) getBounds().width()) - (((double) this.arrowSize) * Math.sqrt(2.0d))) / 2.0d);
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setPivots(float f5, float f6) {
        this.tooltipPivotX = f5;
