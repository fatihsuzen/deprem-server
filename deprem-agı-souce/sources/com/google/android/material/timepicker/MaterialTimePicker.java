...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public static /* synthetic */ void f(MaterialTimePicker materialTimePicker) {
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i5, @NonNull TimePickerView timePickerView2, @NonNull ViewStub viewStub) {
        if (i5 == 0) {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, i5, i6);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, R.styleable.MaterialTimePicker, i5, i6);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                int unused = materialTimePicker.inputMode = i5;
