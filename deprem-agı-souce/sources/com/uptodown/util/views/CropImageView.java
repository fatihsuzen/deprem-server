...
public final class CropImageView extends AppCompatImageView {
    ...
    private final void b(AttributeSet attributeSet) {
        ...
        this.f21327b = obtainStyledAttributes.getInt(0, -1);
    ...
    public boolean setFrame(int i5, int i6, int i7, int i8) {
        ...
        if (!(isInEditMode() || this.f21326a == null || getDrawable() == null)) {
            e eVar = this.f21326a;
            t.b(eVar);
            eVar.a();
        }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ CropImageView(Context context, AttributeSet attributeSet, int i5, int i6, C2633k kVar) {
