...
public class MBridgeDailyPlayModel {
    ...
    public MBridgeDailyPlayModel(int i5, String str, String str2) {
        this.mAdType = i5;
        str = TextUtils.isEmpty(str) ? "null" : str;
        this.mPlacementID = str;
        str2 = TextUtils.isEmpty(str2) ? "null" : str2;
        this.mUnitID = str2;
        String str3 = i5 + "_" + str + "_" + str2;
        this.mCountKey = str3 + "_count";
        this.mTimeKey = str3 + "_time";
    }

    public void insertDailyCap() {
        long j5 = MBridgeSharedPreferenceModel.getInstance().getLong(this.mTimeKey, 0);
    ...
    public boolean isOverDailyCap() {
        ...
        if (System.currentTimeMillis() - j5 > 86400000) {
            MBridgeSharedPreferenceModel.getInstance().putLong(this.mTimeKey, 0);
    ...
    public void setMaxPlayCount(int i5) {
        this.mMaxDailyCap = i5;
    }
}
