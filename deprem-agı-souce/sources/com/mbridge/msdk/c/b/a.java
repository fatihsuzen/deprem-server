...
public class a {
    ...
    private String c() {
        try {
            ...
            af.a("MraidJSController", e5.getMessage());
            return "";
        }
    }
    ...
    public final String b() {
        try {
            ...
            if (b5 != null && !TextUtils.isEmpty(b5.U())) {
                a(com.mbridge.msdk.foundation.controller.c.m().c(), b5.U());
            }
            return f7936a;
    ...
    public final void a(Context context, final String str) {
        if (context != null) {
            String a5 = com.mbridge.msdk.foundation.a.a.a.a().a("MraidJSController");
            if (TextUtils.isEmpty(a5) || !a5.equals(str)) {
                try {
                    new com.mbridge.msdk.c.a.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.f.e) null, (b) new com.mbridge.msdk.foundation.same.net.b.a() {
                        public final void a(String str) {
                            af.a("MraidJSController", "fail request mraid js. " + str);
                        }

                        public final void b(String str) {
                            af.a("MraidJSController", "request mraid js success, content = " + str);
                            if (!TextUtils.isEmpty(str)) {
                                String unused = a.this.f7938c = str;
                    ...
                    }, "mraid_js", (long) ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
                } catch (Exception e5) {
                    af.b("MraidJSController", e5.getMessage());
                }
            }
        }
    }
