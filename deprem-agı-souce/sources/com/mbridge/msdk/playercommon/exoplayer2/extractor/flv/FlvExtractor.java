    ...
    private void ensureReadyForMediaOutput() {
        ...
        if (this.mediaTagTimestampOffsetUs == C.TIME_UNSET) {
            if (this.metadataReader.getDurationUs() == C.TIME_UNSET) {
                j5 = -this.tagTimestampUs;
            } else {
                j5 = 0;
            }
            this.mediaTagTimestampOffsetUs = j5;
        }
    }
