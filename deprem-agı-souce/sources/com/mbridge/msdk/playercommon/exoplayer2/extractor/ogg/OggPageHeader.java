...
final class OggPageHeader {
    ...
    public final boolean populate(ExtractorInput extractorInput, boolean z4) throws IOException, InterruptedException {
        this.scratch.reset();
        reset();
            ...
            if (this.scratch.readUnsignedInt() == ((long) TYPE_OGGS)) {
                ...
                if (readUnsignedByte == 0) {
                    ...
                    for (int i5 = 0; i5 < this.pageSegmentCount; i5++) {
                        this.laces[i5] = this.scratch.readUnsignedByte();
