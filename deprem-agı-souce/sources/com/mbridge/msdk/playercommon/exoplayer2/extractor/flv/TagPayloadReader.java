...
abstract class TagPayloadReader {
    ...
    public final void consume(ParsableByteArray parsableByteArray, long j5) throws ParserException {
        if (parseHeader(parsableByteArray)) {
            parsePayload(parsableByteArray, j5);
        }
    }
    ...
    /* access modifiers changed from: protected */
    public abstract void parsePayload(ParsableByteArray parsableByteArray, long j5) throws ParserException;
