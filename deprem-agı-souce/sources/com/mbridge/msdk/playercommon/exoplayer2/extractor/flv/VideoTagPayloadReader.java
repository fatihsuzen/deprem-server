...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    public final void parsePayload(ParsableByteArray parsableByteArray, long j5) throws ParserException {
        int i5;
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        long readInt24 = j5 + (((long) parsableByteArray.readInt24()) * 1000);
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            while (parsableByteArray.bytesLeft() > 0) {
                parsableByteArray.readBytes(this.nalLength.data, i6, this.nalUnitLengthFieldLength);
            ...
            trackOutput.sampleMetadata(readInt24, i5, i7, 0, (TrackOutput.CryptoData) null);
        }
    }
