...
public final class H264Reader implements ElementaryStreamReader {
    ...
    private static final class SampleReader {
        ...
        private static final class SliceHeaderData {
            ...
            public boolean isFirstVclNalUnitOfPicture(SliceHeaderData sliceHeaderData) {
                ...
                if (sliceHeaderData.isComplete && this.frameNum == sliceHeaderData.frameNum && this.picParameterSetId == sliceHeaderData.picParameterSetId && this.fieldPicFlag == sliceHeaderData.fieldPicFlag && ((!this.bottomFieldFlagPresent || !sliceHeaderData.bottomFieldFlagPresent || this.bottomFieldFlag == sliceHeaderData.bottomFieldFlag) && (((i5 = this.nalRefIdc) == (i6 = sliceHeaderData.nalRefIdc) || (i5 != 0 && i6 != 0)) && (((i7 = this.spsData.picOrderCountType) != 0 || sliceHeaderData.spsData.picOrderCountType != 0 || (this.picOrderCntLsb == sliceHeaderData.picOrderCntLsb && this.deltaPicOrderCntBottom == sliceHeaderData.deltaPicOrderCntBottom)) && ((i7 != 1 || sliceHeaderData.spsData.picOrderCountType != 1 || (this.deltaPicOrderCnt0 == sliceHeaderData.deltaPicOrderCnt0 && this.deltaPicOrderCnt1 == sliceHeaderData.deltaPicOrderCnt1)) && (z4 = this.idrPicFlag) == (z5 = sliceHeaderData.idrPicFlag) && (!z4 || !z5 || this.idrPicId == sliceHeaderData.idrPicId)))))) {
                    return false;
                }
                return true;
            }
            ...
            public final void setAll(NalUnitUtil.SpsData spsData2, int i5, int i6, int i7, int i8, boolean z4, boolean z5, boolean z6, boolean z7, int i9, int i10, int i11, int i12, int i13) {
            ...
            public final void setSliceType(int i5) {
                this.sliceType = i5;
                this.hasSliceType = true;
            }
        }
        ...
        public final void endNalUnit(long j5, int i5) {
            ...
            if (i6 == 5 || (this.allowNonIdrKeyframes && i6 == 1 && this.sliceHeader.isISlice())) {
                z4 = true;
            }
        ...
        public final void startNalUnit(long j5, int i5, long j6) {
            this.nalUnitType = i5;
    ...
    public H264Reader(SeiReader seiReader2, boolean z4, boolean z5) {
