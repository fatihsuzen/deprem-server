...
final class MetadataUtil {
    ...
    private static CommentFrame parseCommentAttribute(int i5, ParsableByteArray parsableByteArray) {
        ...
        Log.w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(i5));
        return null;
    }
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i5, String str, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        ...
        Log.w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i5));
        return null;
    }

    private static Id3Frame parseInternalAttribute(ParsableByteArray parsableByteArray, int i5) {
        String str = null;
        String str2 = null;
        int i6 = -1;
        int i7 = -1;
        ...
        return new InternalFrame(str, str2, parsableByteArray.readNullTerminatedString(i7 - 16));
    }
    ...
    private static TextInformationFrame parseTextAttribute(int i5, String str, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        if (parsableByteArray.readInt() == Atom.TYPE_data) {
            parsableByteArray.skipBytes(8);
            return new TextInformationFrame(str, (String) null, parsableByteArray.readNullTerminatedString(readInt - 16));
        }
        Log.w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(i5));
        return null;
    }

    private static Id3Frame parseUint8Attribute(int i5, String str, ParsableByteArray parsableByteArray, boolean z4, boolean z5) {
        ...
        if (parseUint8AttributeValue < 0) {
            Log.w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i5));
            return null;
        } else if (z4) {
