...
public final class Mp4WebvttDecoder extends SimpleSubtitleDecoder {
    ...
    private static Cue parseVttCueBox(ParsableByteArray parsableByteArray, WebvttCue.Builder builder2, int i5) throws SubtitleDecoderException {
        builder2.reset();
        while (i5 > 0) {
            if (i5 >= 8) {
                ...
                int i6 = readInt - 8;
                String fromUtf8Bytes = Util.fromUtf8Bytes(parsableByteArray.data, parsableByteArray.getPosition(), i6);
    ...
    public final Mp4WebvttSubtitle decode(byte[] bArr, int i5, boolean z4) throws SubtitleDecoderException {
