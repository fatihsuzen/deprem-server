...
public final class ExtractorMediaSource extends BaseMediaSource implements ExtractorMediaPeriod.Listener {
    ...
    public static final class Factory implements AdsMediaSource.MediaSourceFactory {
        ...
        public final Factory setContinueLoadingCheckIntervalBytes(int i5) {
    ...
    private void notifySourceInfoRefreshed(long j5, boolean z4) {
    ...
    public final void onSourceInfoRefreshed(long j5, boolean z4) {
        if (j5 == C.TIME_UNSET) {
            j5 = this.timelineDurationUs;
        }
        if (this.timelineDurationUs != j5 || this.timelineIsSeekable != z4) {
            notifySourceInfoRefreshed(j5, z4);
        }
    }
    ...
    @Deprecated
    public ExtractorMediaSource(Uri uri2, DataSource.Factory factory, ExtractorsFactory extractorsFactory2, int i5, Handler handler, EventListener eventListener, String str, int i6) {
        this(uri2, factory, extractorsFactory2, i5, str, i6, (Object) null);
        if (eventListener != null && handler != null) {
            addEventListener(handler, new EventListenerWrapper(eventListener));
        }
    }

    private ExtractorMediaSource(Uri uri2, DataSource.Factory factory, ExtractorsFactory extractorsFactory2, int i5, @Nullable String str, int i6, @Nullable Object obj) {
        this.uri = uri2;
        this.dataSourceFactory = factory;
        this.extractorsFactory = extractorsFactory2;
        this.minLoadableRetryCount = i5;
