...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    public static final class DefaultKeyStatus implements KeyStatus {
        ...
        DefaultKeyStatus(int i5, byte[] bArr) {
            this.statusCode = i5;
            this.keyId = bArr;
        }
    ...
    public interface OnEventListener<T extends ExoMediaCrypto> {
        void onEvent(ExoMediaDrm<? extends T> exoMediaDrm, byte[] bArr, int i5, int i6, @Nullable byte[] bArr2);
    }

    public interface OnKeyStatusChangeListener<T extends ExoMediaCrypto> {
        void onKeyStatusChange(ExoMediaDrm<? extends T> exoMediaDrm, byte[] bArr, List<KeyStatus> list, boolean z4);
    }
    ...
    KeyRequest getKeyRequest(byte[] bArr, byte[] bArr2, String str, int i5, HashMap<String, String> hashMap) throws NotProvisionedException;
