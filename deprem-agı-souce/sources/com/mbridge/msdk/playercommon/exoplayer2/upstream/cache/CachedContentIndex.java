...
class CachedContentIndex {
    ...
    private boolean readFile() {
        /*
            ...
            int r1 = r3.readInt()     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            if (r1 < 0) goto L_0x0094
            r4 = 2
            if (r1 <= r4) goto L_0x001d
            goto L_0x0094
        L_0x001d:
            int r5 = r3.readInt()     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x005c
            javax.crypto.Cipher r5 = r9.cipher     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            if (r5 != 0) goto L_0x002d
            com.mbridge.msdk.playercommon.exoplayer2.util.Util.closeQuietly((java.io.Closeable) r3)
            return r0
        L_0x002d:
            r5 = 16
            byte[] r5 = new byte[r5]     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r3.readFully(r5)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            javax.crypto.spec.IvParameterSpec r7 = new javax.crypto.spec.IvParameterSpec     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r7.<init>(r5)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            javax.crypto.Cipher r5 = r9.cipher     // Catch:{ InvalidKeyException -> 0x0055, InvalidAlgorithmParameterException -> 0x0053 }
            javax.crypto.spec.SecretKeySpec r8 = r9.secretKeySpec     // Catch:{ InvalidKeyException -> 0x0055, InvalidAlgorithmParameterException -> 0x0053 }
            r5.init(r4, r8, r7)     // Catch:{ InvalidKeyException -> 0x0055, InvalidAlgorithmParameterException -> 0x0053 }
            java.io.DataInputStream r4 = new java.io.DataInputStream     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            javax.crypto.CipherInputStream r5 = new javax.crypto.CipherInputStream     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            javax.crypto.Cipher r7 = r9.cipher     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r5.<init>(r2, r7)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
        ...
        L_0x0055:
            r1 = move-exception
        L_0x0056:
            java.lang.IllegalStateException r2 = new java.lang.IllegalStateException     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r2.<init>(r1)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            throw r2     // Catch:{ IOException -> 0x0051, all -> 0x004e }
        L_0x005c:
            boolean r2 = r9.encrypt     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            if (r2 == 0) goto L_0x0062
            r9.changed = r6     // Catch:{ IOException -> 0x0051, all -> 0x004e }
        L_0x0062:
            int r2 = r3.readInt()     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r4 = r0
            r5 = r4
        L_0x0068:
            if (r4 >= r2) goto L_0x0079
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedContent r7 = com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedContent.readFromStream(r1, r3)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r9.add(r7)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            int r7 = r7.headerHashCode(r1)     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            int r5 = r5 + r7
            int r4 = r4 + 1
            goto L_0x0068
        L_0x0079:
            int r1 = r3.readInt()     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            int r2 = r3.read()     // Catch:{ IOException -> 0x0051, all -> 0x004e }
            r4 = -1
    ...
    public CachedContentIndex(File file, byte[] bArr, boolean z4) {
        this.encrypt = z4;
        boolean z5 = true;
        if (bArr != null) {
            Assertions.checkArgument(bArr.length != 16 ? false : z5);
            try {
