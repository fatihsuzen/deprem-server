...
public interface Cache {
    ...
    void setContentLength(String str, long j5) throws CacheException;

    File startFile(String str, long j5, long j6) throws CacheException;

    CacheSpan startReadWrite(String str, long j5) throws InterruptedException, CacheException;

    @Nullable
    CacheSpan startReadWriteNonBlocking(String str, long j5) throws CacheException;
}
