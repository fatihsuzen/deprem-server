...
public final class ParsingLoadable<T> implements Loader.Loadable {
    ...
    public ParsingLoadable(DataSource dataSource2, Uri uri, int i5, Parser<? extends T> parser2) {
        this(dataSource2, new DataSpec(uri, 3), i5, parser2);
    }
    ...
    public ParsingLoadable(DataSource dataSource2, DataSpec dataSpec2, int i5, Parser<? extends T> parser2) {
