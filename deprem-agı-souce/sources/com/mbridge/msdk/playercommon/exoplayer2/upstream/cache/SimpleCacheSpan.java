...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static SimpleCacheSpan createClosedHole(String str, long j5, long j6) {
        return new SimpleCacheSpan(str, j5, j6, C.TIME_UNSET, (File) null);
    }

    public static SimpleCacheSpan createLookup(String str, long j5) {
        return new SimpleCacheSpan(str, j5, -1, C.TIME_UNSET, (File) null);
    }

    public static SimpleCacheSpan createOpenHole(String str, long j5) {
        return new SimpleCacheSpan(str, j5, -1, C.TIME_UNSET, (File) null);
    }

    public static File getCacheFile(File file, int i5, long j5, long j6) {
        return new File(file, i5 + "." + j5 + "." + j6 + SUFFIX);
    }
    ...
    public final SimpleCacheSpan copyWithUpdatedLastAccessTime(int i5) {
        Assertions.checkState(this.isCached);
        long currentTimeMillis = System.currentTimeMillis();
        return new SimpleCacheSpan(this.key, this.position, this.length, currentTimeMillis, getCacheFile(this.file.getParentFile(), i5, this.position, currentTimeMillis));
    }
}
