...
public abstract class SegmentDownloader<M extends FilterableManifest<M, K>, K> implements Downloader {
    ...
    protected static class Segment implements Comparable<Segment> {
        ...
        public Segment(long j5, DataSpec dataSpec2) {
            this.startTimeUs = j5;
            this.dataSpec = dataSpec2;
        }

        public int compareTo(@NonNull Segment segment) {
            int i5 = ((this.startTimeUs - segment.startTimeUs) > 0 ? 1 : ((this.startTimeUs - segment.startTimeUs) == 0 ? 0 : -1));
            if (i5 == 0) {
                return 0;
            }
            return i5 < 0 ? -1 : 1;
    ...
    public final void download() throws IOException, InterruptedException {
        ...
        try {
            ...
            for (int i5 = 0; i5 < initDownload.size(); i5++) {
                CacheUtil.cache(initDownload.get(i5).dataSpec, this.cache, this.dataSource, bArr, this.priorityTaskManager, -1000, cachingCounters, this.isCanceled, true);
                this.downloadedSegments++;
    ...
    public final float getDownloadPercentage() {
        ...
        int i6 = this.downloadedSegments;
        if (i5 == -1 || i6 == -1) {
            return -1.0f;
        }
        if (i5 == 0) {
        ...
        return (((float) i6) * 100.0f) / ((float) i5);
    }
    ...
    /* access modifiers changed from: protected */
    public abstract List<Segment> getSegments(DataSource dataSource2, M m5, boolean z4) throws InterruptedException, IOException;
    ...
    public final void remove() throws InterruptedException {
        try {
            ...
            for (int i5 = 0; i5 < segments.size(); i5++) {
                removeUri(segments.get(i5).dataSpec.uri);
            }
