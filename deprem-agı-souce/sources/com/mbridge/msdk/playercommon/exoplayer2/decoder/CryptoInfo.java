...
public final class CryptoInfo {
    ...
    public CryptoInfo() {
        ...
        this.frameworkCryptoInfo = cryptoInfo;
        this.patternHolder = i5 >= 24 ? new PatternHolderV24(cryptoInfo) : patternHolderV24;
    }
    ...
    public final void set(int i5, int[] iArr, int[] iArr2, byte[] bArr, byte[] bArr2, int i6, int i7, int i8) {
