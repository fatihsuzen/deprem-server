...
public class LoadingActivity extends Activity {
    ...
    private View initView() {
        if (this.rlayout_main == null) {
            ...
            int a5 = ak.a((Context) this, 15.0f);
            this.rlayout.setPadding(a5, a5, a5, a5);
            this.rlayout.setBackgroundResource(getResources().getIdentifier("mbridge_native_bg_loading_camera", "drawable", getPackageName()));
            this.rlayout.addView(new TextView(this), new RelativeLayout.LayoutParams(ak.a((Context) this, 140.0f), ak.a((Context) this, 31.5f)));
            ...
            int a6 = ak.a((Context) this, 64.0f);
