...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j5, long j6, int i5, int i6, DownloadResourceType downloadResourceType2, int i7) {
        ...
        downloadModel.setDownloadedBytes(j6);
        downloadModel.setTotalBytes(j5);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i6);
        downloadModel.setDownloadRate(i5);
    ...
    public void setLastModifiedTime(long j5) {
    ...
    public void setUnZipResourceByte(long j5) {
        this.unZipResourceByte = j5;
    }
    ...
    public void setUsageCounter(int i5) {
        this.usageCounter = i5;
    }

    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j5, long j6, int i5, int i6, DownloadResourceType downloadResourceType2) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
