...
public class MBDownloadConfig {
    ...
    public static final class Builder {
        ...
        public final Builder setDefaultConnectTimeout(long j5) {
            this.defaultConnectTimeout = j5;
            return this;
        }

        public final Builder setDefaultPingInterval(long j5) {
            this.defaultPingInterval = j5;
            return this;
        }

        public final Builder setDefaultReadTimeout(long j5) {
            this.defaultReadTimeout = j5;
            return this;
        }

        public final Builder setDefaultWriteTimeout(long j5) {
            this.defaultWriteTimeout = j5;
            return this;
        }
        ...
        public final Builder setMaxRequests(int i5) {
            this.maxRequests = i5;
            return this;
        }

        public final Builder setMaxRequestsPerHost(int i5) {
