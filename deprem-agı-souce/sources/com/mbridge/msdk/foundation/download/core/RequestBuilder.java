...
public interface RequestBuilder<T> {
    ...
    RequestBuilder<T> withConnectTimeout(long j5);
    ...
    RequestBuilder<T> withHttpRetryCounter(int i5);

    RequestBuilder<T> withProgressStateListener(OnProgressStateListener onProgressStateListener);

    RequestBuilder<T> withReadTimeout(long j5);

    RequestBuilder<T> withTimeout(long j5);

    RequestBuilder<T> withUserAgent(String str);

    RequestBuilder<T> withWriteTimeout(long j5);
}
