...
public class DownloadRequestBuilder<T> implements RequestBuilder<T> {
    ...
    public RequestBuilder<T> withTimeout(long j5) {
        this.timeout = j5;
        return this;
    }

    public RequestBuilder<T> withWriteTimeout(long j5) {
        this.writeTimeout = j5;
        return this;
    }

    public DownloadRequestBuilder<T> withConnectTimeout(long j5) {
    ...
    public DownloadRequestBuilder<T> withHttpRetryCounter(int i5) {
        this.retry = i5;
        return this;
    }

    public DownloadRequestBuilder<T> withReadTimeout(long j5) {
        this.readTimeout = j5;
        return this;
    }
