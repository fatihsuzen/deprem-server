...
public class MBHorizontalScrollView extends HorizontalScrollView implements InterBase {
    ...
    private Map<String, String> f8330a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f8331b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8333a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8333a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f8333a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f8333a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.MBHorizontalScrollView.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f8330a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f8330a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f8330a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f8330a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f8330a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f8330a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f8331b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f8331b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f8332c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f8331b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f8331b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f8332c);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f8331b = c.a(str);
        if (campaignEx != null) {
            this.f8332c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                int i6 = AnonymousClass1.f8333a[cVar.ordinal()];
                if (i6 == 1) {
    ...
    public MBHorizontalScrollView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f8330a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f8330a, (View) this);
        } catch (Exception e5) {
            af.b("MBHorizontalScrollView", e5.getMessage());
        }
    }

    public MBHorizontalScrollView(Context context, AttributeSet attributeSet, int i5) {
