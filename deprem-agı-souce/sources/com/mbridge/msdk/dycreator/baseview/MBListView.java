...
public class MBListView extends ListView implements InterBase {
    ...
    private Map<String, String> f8348a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f8349b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8351a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8351a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f8351a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.MBListView.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public MBListView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f8348a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f8348a, (View) this);
        } catch (Exception e5) {
            af.b("MBListView", e5.getMessage());
        }
    }

    public String getActionDes() {
        Map<String, String> map = this.f8348a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f8348a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f8348a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f8348a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f8348a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f8348a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f8349b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f8349b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f8350c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f8349b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f8349b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f8350c);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f8349b = c.a(str);
        if (campaignEx != null) {
            this.f8350c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public AbsListView.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                int i6 = AnonymousClass1.f8351a[cVar.ordinal()];
                if (i6 == 1) {
