...
public class MBPlayerView extends PlayerView implements InterBase {
    ...
    private Map<String, String> f8354c;

    /* renamed from: d  reason: collision with root package name */
    private Map<String, Boolean> f8355d;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x0054:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f8357a     // Catch:{ NoSuchFieldError -> 0x0090 }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f8354c;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f8354c.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f8354c.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f8354c.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f8354c.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f8354c.get("mbridgeStrategy");
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f8355d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f8355d.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f8356e);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f8355d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f8355d.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f8356e);
        }
    }

    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        this.f8352a = motionEvent.getRawX();
        this.f8353b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f8355d = c.a(str);
        if (campaignEx != null) {
            this.f8356e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public LinearLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f8357a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        layoutParams.weight = attributeSet.getAttributeFloatValue(i5, 0.0f);
                        break;
                    case 6:
    ...
    public MBPlayerView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f8354c = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f8354c, (View) this);
        } catch (Exception e5) {
            af.b("MBLinearLayout", e5.getMessage());
        }
    }
}
