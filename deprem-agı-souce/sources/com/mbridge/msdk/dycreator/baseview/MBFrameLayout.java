...
public class MBFrameLayout extends FrameLayout implements InterBase, InterEffect {
    ...
    private Animator f8321a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, String> f8322b;

    /* renamed from: c  reason: collision with root package name */
    private Map<String, Boolean> f8323c;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8325a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8325a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f8325a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f8325a     // Catch:{ NoSuchFieldError -> 0x003e }
    ...
    public MBFrameLayout(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f8322b = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f8322b, (View) this);
        } catch (Exception e5) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f8322b;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f8322b.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f8322b.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f8322b.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f8322b.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f8322b.get("mbridgeStrategy");
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f8323c;
        if (map != null && map.containsKey("mbridgeAttached") && this.f8323c.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f8324d);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f8323c;
        if (map != null && map.containsKey("mbridgeDetached") && this.f8323c.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f8324d);
        }
    }

    public void setAnimator(Animator animator) {
        this.f8321a = animator;
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f8323c = c.a(str);
        if (campaignEx != null) {
            this.f8324d = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                int i6 = AnonymousClass1.f8325a[cVar.ordinal()];
                if (i6 == 1) {
