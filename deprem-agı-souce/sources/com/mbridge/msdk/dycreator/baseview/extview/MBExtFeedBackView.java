...
public class MBExtFeedBackView extends FeedBackButton implements InterBase {
    ...
    private Map<String, String> f8512a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f8513b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0049:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x0090:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x00f0:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0138 }
                com.mbridge.msdk.dycreator.a.c r1 = com.mbridge.msdk.dycreator.a.c.layout_width     // Catch:{ NoSuchFieldError -> 0x0138 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0138 }
                r2 = 26
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0138 }
            L_0x0138:
                int[] r0 = f8515a     // Catch:{ NoSuchFieldError -> 0x0144 }
                com.mbridge.msdk.dycreator.a.c r1 = com.mbridge.msdk.dycreator.a.c.layout_height     // Catch:{ NoSuchFieldError -> 0x0144 }
            ...
            L_0x0144:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.extview.MBExtFeedBackView.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                int i6 = AnonymousClass1.f8515a[cVar.ordinal()];
                if (i6 == 26) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f8512a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f8512a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f8512a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f8512a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f8512a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f8512a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f8513b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f8513b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f8514c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f8513b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f8513b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f8514c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i9 = 0; i9 < attributeCount; i9++) {
            c cVar = c5.get(attributeSet.getAttributeName(i9));
            if (cVar != null) {
                Log.d("setupview", cVar.toString());
                switch (AnonymousClass1.f8515a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 2:
                        ...
                        if (!TextUtils.isEmpty(attributeValue2)) {
                            if (!attributeValue2.startsWith("@string/")) {
                                ...
                                setText(b.a().e(attributeSet.getAttributeValue(i9)));
                                break;
                            }
                        } else {
                            break;
                    ...
                    case 4:
                        setSingleLine(attributeSet.getAttributeBooleanValue(i9, false));
                        break;
                    case 5:
                        setLines(attributeSet.getAttributeIntValue(i9, 1));
                        break;
                    case 6:
                    ...
                    case 7:
                        setCompoundDrawablePadding(b.a().b(attributeSet.getAttributeValue(i9)));
                        break;
                    case 8:
                        setHorizontalFadingEdgeEnabled(attributeSet.getAttributeBooleanValue(i9, false));
                        break;
                    case 9:
                        setHorizontallyScrolling(attributeSet.getAttributeBooleanValue(i9, false));
                        break;
                    case 10:
                        setTextColor(b.a().a(attributeSet.getAttributeValue(i9)));
                        break;
                    case 11:
                    ...
                    case 14:
                        if (!TtmlNode.BOLD.equalsIgnoreCase(attributeSet.getAttributeValue(i9))) {
                            break;
                        } else {
                    ...
                    case 18:
                        ...
                        break;
                    case 19:
                        int b5 = b.a().b(attributeSet.getAttributeValue(i9));
                        setPadding(b5, b5, b5, b5);
                        break;
                    case 20:
                        i8 = b.a().b(attributeSet.getAttributeValue(i9));
                        setPadding(i5, i8, i6, i7);
                        break;
                    case 21:
                        i7 = b.a().b(attributeSet.getAttributeValue(i9));
                        setPadding(i5, i8, i6, i7);
                        break;
                    case 22:
                        i5 = b.a().b(attributeSet.getAttributeValue(i9));
                        setPadding(i5, i8, i6, i7);
                        break;
                    case 23:
                        i6 = b.a().b(attributeSet.getAttributeValue(i9));
                        setPadding(i5, i8, i6, i7);
                        break;
                    case 24:
                        setPadding(b.a().b(attributeSet.getAttributeValue(i9)), i8, i6, i7);
                        break;
                    case 25:
                        setPadding(i5, i8, b.a().b(attributeSet.getAttributeValue(i9)), i7);
                        break;
                }
            }
        }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f8513b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f8514c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBExtFeedBackView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f8512a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f8512a, (View) this);
        } catch (Exception e5) {
            af.b("MBExtFeedBackView", e5.getMessage());
        }
    }

    public MBExtFeedBackView(Context context, AttributeSet attributeSet, int i5) {
