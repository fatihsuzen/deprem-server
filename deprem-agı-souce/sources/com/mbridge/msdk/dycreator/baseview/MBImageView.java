...
public class MBImageView extends ImageView implements InterBase {
    ...
    private Map<String, Boolean> f8334a;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f8337a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f8337a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public MBImageView(Context context, AttributeSet attributeSet) {
        ...
        if (!(context == null || attributeSet == null)) {
            try {
                this.f8336c = c.a(context, attributeSet);
            } catch (Exception e5) {
    ...
    public ViewGroup.LayoutParams generateLayoutParams(Context context, AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                int i6 = AnonymousClass1.f8337a[cVar.ordinal()];
                if (i6 == 1) {
    ...
    public String getActionDes() {
        ...
        return this.f8336c.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f8336c.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f8336c.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f8336c.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f8336c.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f8334a;
        if (map != null && map.containsKey("mbridgeAttached") && this.f8334a.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f8335b);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f8334a;
        if (map != null && map.containsKey("mbridgeDetached") && this.f8334a.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f8335b);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f8334a = c.a(str);
        if (campaignEx != null) {
            this.f8335b = campaignEx.getCampaignUnitId();
        }
    }
}
