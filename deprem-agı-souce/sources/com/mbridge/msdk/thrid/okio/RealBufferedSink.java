...
final class RealBufferedSink implements BufferedSink {
    ...
    public OutputStream outputStream() {
        return new OutputStream() {
            ...
            public void write(byte[] bArr, int i5, int i6) throws IOException {
                RealBufferedSink realBufferedSink = RealBufferedSink.this;
                if (!realBufferedSink.closed) {
                    realBufferedSink.buffer.write(bArr, i5, i6);
                    RealBufferedSink.this.emitCompleteSegments();
                    return;
                }
                throw new IOException("closed");
    ...
    public void write(Buffer buffer2, long j5) throws IOException {
        if (!this.closed) {
            this.buffer.write(buffer2, j5);
    ...
    public BufferedSink writeDecimalLong(long j5) throws IOException {
        if (!this.closed) {
            this.buffer.writeDecimalLong(j5);
            return emitCompleteSegments();
        }
        throw new IllegalStateException("closed");
    }

    public BufferedSink writeHexadecimalUnsignedLong(long j5) throws IOException {
        if (!this.closed) {
            this.buffer.writeHexadecimalUnsignedLong(j5);
            return emitCompleteSegments();
        }
        throw new IllegalStateException("closed");
    }
    ...
    public BufferedSink writeLongLe(long j5) throws IOException {
        if (!this.closed) {
            this.buffer.writeLongLe(j5);
            return emitCompleteSegments();
        }
        throw new IllegalStateException("closed");
    }
    ...
    public BufferedSink writeString(String str, int i5, int i6, Charset charset) throws IOException {
        if (!this.closed) {
            this.buffer.writeString(str, i5, i6, charset);
            return emitCompleteSegments();
        }
        throw new IllegalStateException("closed");
    }

    public BufferedSink writeUtf8(String str, int i5, int i6) throws IOException {
        if (!this.closed) {
            this.buffer.writeUtf8(str, i5, i6);
            return emitCompleteSegments();
        }
        throw new IllegalStateException("closed");
    }
    ...
    public BufferedSink write(Source source, long j5) throws IOException {
        while (j5 > 0) {
            long read = source.read(this.buffer, j5);
            if (read != -1) {
                j5 -= read;
                emitCompleteSegments();
            } else {
