...
public class Timeout {
    public static final Timeout NONE = new Timeout() {
        ...
        public Timeout timeout(long j5, TimeUnit timeUnit) {
            return this;
        }
    };
    ...
    public final Timeout deadline(long j5, TimeUnit timeUnit) {
        if (j5 <= 0) {
            throw new IllegalArgumentException("duration <= 0: " + j5);
        } else if (timeUnit != null) {
            return deadlineNanoTime(System.nanoTime() + timeUnit.toNanos(j5));
        } else {
    ...
    public final void waitUntilNotified(Object obj) throws InterruptedIOException {
        try {
            ...
            if (hasDeadline2 || timeoutNanos2 != 0) {
                ...
                if (timeoutNanos2 > 0) {
                    long j6 = timeoutNanos2 / 1000000;
                    Long.signum(j6);
                    obj.wait(j6, (int) (timeoutNanos2 - (1000000 * j6)));
