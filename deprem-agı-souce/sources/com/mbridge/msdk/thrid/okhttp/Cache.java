...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File file, long j5, FileSystem fileSystem) {
        ...
        this.cache = DiskLruCache.create(fileSystem, file, VERSION, 2, j5);
    }
    ...
    private static final class Entry {
        ...
        Entry(Source source) throws IOException {
            try {
                ...
                this.receivedResponseMillis = str4 != null ? Long.parseLong(str4) : j5;
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            for (int i6 = 0; i6 < size2; i6++) {
                buffer.writeUtf8(this.responseHeaders.name(i6)).writeUtf8(": ").writeUtf8(this.responseHeaders.value(i6)).writeByte(10);
            }
