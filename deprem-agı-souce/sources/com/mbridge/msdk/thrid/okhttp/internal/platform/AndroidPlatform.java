...
class AndroidPlatform extends Platform {
    ...
    static final class CloseGuard {
        ...
        public boolean warnIfOpen(Object obj) {
            ...
            try {
                this.warnIfOpenMethod.invoke(obj, (Object[]) null);
                return true;
            } catch (Exception unused) {
                return false;
            }
    ...
    public boolean isCleartextTrafficPermitted(String str) {
        try {
            ...
            return api24IsCleartextTrafficPermitted(str, cls, cls.getMethod("getInstance", (Class[]) null).invoke((Object) null, (Object[]) null));
    ...
    public void log(int i5, String str, Throwable th) {
        ...
        while (i7 < length) {
            ...
            while (true) {
                min = Math.min(indexOf, i7 + MAX_LOG_LENGTH);
