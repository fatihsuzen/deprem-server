...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (CampaignEx.JSON_NATIVE_VIDEO_CLOSE.equalsIgnoreCase(response.request().header("Connection")) || CampaignEx.JSON_NATIVE_VIDEO_CLOSE.equalsIgnoreCase(response.header("Connection"))) {
            streamAllocation.noNewStreams();
        }
