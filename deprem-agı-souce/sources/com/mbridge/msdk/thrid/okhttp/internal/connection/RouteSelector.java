...
public final class RouteSelector {
    ...
    public RouteSelector(Address address2, RouteDatabase routeDatabase2, Call call2, EventListener eventListener2) {
        List<Proxy> list = Collections.EMPTY_LIST;
        this.proxies = list;
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (i5 < 1 || i5 > 65535) {
            ...
            this.inetSocketAddresses.add(InetSocketAddress.createUnresolved(str, i5));
        } else {
            ...
            if (!lookup.isEmpty()) {
                ...
                for (int i6 = 0; i6 < size; i6++) {
                    this.inetSocketAddresses.add(new InetSocketAddress(lookup.get(i6), i5));
                }
                return;
            }
        ...
        if (hasNext()) {
            ...
            while (hasNextProxy()) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    Route route = new Route(this.address, nextProxy, this.inetSocketAddresses.get(i5));
