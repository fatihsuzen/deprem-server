...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i5, Bundle bundle) {
            ...
            mediaBrowserServiceCompat.mCurConnection = new ConnectionRecord(str2, -1, i6, bundle3, (ServiceCallbacks) null);
            BrowserRoot onGetRoot = MediaBrowserServiceCompat.this.onGetRoot(str2, i6, bundle3);
                    ...
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (c5 != null) {
                            for (Bundle putBinder : MediaBrowserServiceImplApi21.this.mRootExtrasList) {
                                BundleCompat.putBinder(putBinder, MediaBrowserProtocol.EXTRA_SESSION_BINDER, c5.asBinder());
                            }
                        }
                        MediaBrowserServiceImplApi21.this.mRootExtrasList.clear();
                    }
                    MediaBrowserServiceCompatApi21.setSessionToken(MediaBrowserServiceImplApi21.this.mServiceObj, token.d());
                }
            });
        }
    ...
    public static class Result<T> {
        ...
        private void checkExtraFields(Bundle bundle) {
            if (bundle != null && bundle.containsKey("android.media.browse.extra.DOWNLOAD_PROGRESS")) {
                float f5 = bundle.getFloat("android.media.browse.extra.DOWNLOAD_PROGRESS");
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(String str, int i5, int i6, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i6)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str2, i7, i8, bundle2, serviceCallbacks2);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
                        BrowserRoot onGetRoot = mediaBrowserServiceCompat.onGetRoot(str2, i8, bundle2);
        ...
        public void getMediaItem(final String str, final d.b bVar, final ServiceCallbacks serviceCallbacks) {
        ...
        public void registerCallbacks(ServiceCallbacks serviceCallbacks, String str, int i5, int i6, Bundle bundle) {
            final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
            final String str2 = str;
            final int i7 = i5;
            final int i8 = i6;
        ...
        public void search(String str, Bundle bundle, d.b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final String str2 = str;
                final Bundle bundle2 = bundle;
        ...
        public void sendCustomAction(String str, Bundle bundle, d.b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final String str2 = str;
                final Bundle bundle2 = bundle;
                final d.b bVar2 = bVar;
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 1:
                    String str = MediaBrowserProtocol.DATA_CALLING_UID;
                    String str2 = MediaBrowserProtocol.DATA_CALLING_PID;
                    Bundle bundle = data.getBundle(MediaBrowserProtocol.DATA_ROOT_HINTS);
                    MediaSessionCompat.a(bundle);
                    this.mServiceBinderImpl.connect(data.getString(MediaBrowserProtocol.DATA_PACKAGE_NAME), data.getInt(str2), data.getInt(str), bundle, new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 2:
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (d.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                    ...
                    serviceBinderImpl.registerCallbacks(new ServiceCallbacksCompat(message.replyTo), data.getString(MediaBrowserProtocol.DATA_PACKAGE_NAME), data.getInt(MediaBrowserProtocol.DATA_CALLING_PID), data.getInt(str3), bundle3);
                    return;
                case 7:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (d.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (d.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    public boolean isValidPackage(String str, int i5) {
        ...
        for (String equals : getPackageManager().getPackagesForUid(i5)) {
    ...
    /* access modifiers changed from: package-private */
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final d.b bVar) {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        AnonymousClass1 r02 = new Result<List<MediaBrowserCompat.MediaItem>>(str3) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
        ...
        if (bundle3 == null) {
            onLoadChildren(str3, r02);
        } else {
            onLoadChildren(str3, r02, bundle3);
        }
        this.mCurConnection = null;
        if (!r02.isDone()) {
            throw new IllegalStateException("onLoadChildren must call detach() or sendResult() before returning for package=" + connectionRecord2.pkg + " id=" + str3);
        }
    }

    /* access modifiers changed from: package-private */
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final d.b bVar) {
        AnonymousClass2 r02 = new Result<MediaBrowserCompat.MediaItem>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
                    bVar.b(-1, (Bundle) null);
                    return;
                }
    ...
    /* access modifiers changed from: package-private */
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final d.b bVar) {
