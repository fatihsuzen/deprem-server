...
final class WeightTypefaceApi26 {
    ...
    private static long nativeCreateFromTypefaceWithExactStyle(long j5, int i5, boolean z4) {
        try {
            return ((Long) sNativeCreateFromTypefaceWithExactStyle.invoke((Object) null, new Object[]{Long.valueOf(j5), Integer.valueOf(i5), Boolean.valueOf(z4)})).longValue();
        } catch (IllegalAccessException e5) {
            throw new RuntimeException(e5);
