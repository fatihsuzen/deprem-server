...
class RequestExecutor {
    ...
    static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i5, @IntRange(from = 0) int i6) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, 1, (long) i6, TimeUnit.MILLISECONDS, new LinkedBlockingDeque(), new DefaultThreadFactory(str, i5));
    ...
    static <T> T submit(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = 0) int i5) throws InterruptedException {
        try {
