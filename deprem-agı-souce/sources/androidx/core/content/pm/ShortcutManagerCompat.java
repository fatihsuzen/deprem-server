...
public class ShortcutManagerCompat {
    ...
    public static boolean addDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i5 >= 25) {
            ...
            if (!Y.a(context.getSystemService(M.a())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List<Object> a5 = Y.a(context.getSystemService(M.a())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(a5.size());
            for (Object a6 : a5) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, C0279f.a(a6)).build());
            }
            return arrayList;
        }
        try {
    ...
    private static int getIconDimensionInternal(@NonNull Context context, boolean z4) {
        ...
        return (int) (((float) max) * (f5 / 160.0f));
    }

    public static int getIconMaxHeight(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return Y.a(context.getSystemService(M.a())).getIconMaxHeight();
        }
    ...
    public static int getIconMaxWidth(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return Y.a(context.getSystemService(M.a())).getIconMaxWidth();
        }
    ...
    public static int getMaxShortcutCountPerActivity(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return Y.a(context.getSystemService(M.a())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i5) {
        ...
        if (i6 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, Y.a(context.getSystemService(M.a())).getShortcuts(i5));
        }
        if (i6 >= 25) {
    ...
    public static boolean isRateLimitingActive(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return Y.a(context.getSystemService(M.a())).isRateLimitingActive();
        }
    ...
    public static boolean isRequestPinShortcutSupported(@androidx.annotation.NonNull android.content.Context r4) {
        /*
            ...
            java.lang.Class r0 = androidx.core.content.pm.M.a()
            java.lang.Object r4 = r4.getSystemService(r0)
            android.content.pm.ShortcutManager r4 = androidx.core.content.pm.Y.a(r4)
    ...
    private static List<ShortcutInfoCompat> removeShortcutsExcludedFromSurface(@NonNull List<ShortcutInfoCompat> list, int i5) {
        ...
        ArrayList arrayList = new ArrayList(list);
        for (ShortcutInfoCompat next : list) {
            if (next.isExcludedFromSurfaces(i5)) {
    ...
    public static boolean requestPinShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat, @Nullable final IntentSender intentSender) {
        ...
        if (i5 >= 26) {
            return Y.a(context.getSystemService(M.a())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static boolean setDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!Y.a(context.getSystemService(M.a())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
    ...
    public static boolean updateShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i5 >= 25) {
            ...
            if (!Y.a(context.getSystemService(M.a())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(removeShortcutsExcludedFromSurface);
