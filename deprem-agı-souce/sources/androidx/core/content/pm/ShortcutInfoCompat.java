...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull ShortcutInfo shortcutInfo) {
            ...
            Intent[] a5 = shortcutInfo.getIntents();
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(a5, a5.length);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo a5 : list) {
            arrayList.add(new Builder(context, C0279f.a(a5)).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        C0283j.a();
        ShortcutInfo.Builder a5 = C0282i.a(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
        IconCompat iconCompat = this.mIcon;
        if (iconCompat != null) {
            ShortcutInfo.Builder unused = a5.setIcon(iconCompat.toIcon(this.mContext));
        }
        if (!TextUtils.isEmpty(this.mLongLabel)) {
            ShortcutInfo.Builder unused2 = a5.setLongLabel(this.mLongLabel);
        }
        if (!TextUtils.isEmpty(this.mDisabledMessage)) {
            ShortcutInfo.Builder unused3 = a5.setDisabledMessage(this.mDisabledMessage);
        }
        ComponentName componentName = this.mActivity;
        if (componentName != null) {
            ShortcutInfo.Builder unused4 = a5.setActivity(componentName);
        }
        Set<String> set = this.mCategories;
        if (set != null) {
            ShortcutInfo.Builder unused5 = a5.setCategories(set);
        }
        ShortcutInfo.Builder unused6 = a5.setRank(this.mRank);
        PersistableBundle persistableBundle = this.mExtras;
        if (persistableBundle != null) {
            ShortcutInfo.Builder unused7 = a5.setExtras(persistableBundle);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                ShortcutInfo.Builder unused8 = a5.setPersons(personArr2);
            }
            LocusIdCompat locusIdCompat = this.mLocusId;
            if (locusIdCompat != null) {
                ShortcutInfo.Builder unused9 = a5.setLocusId(locusIdCompat.toLocusId());
            }
            ShortcutInfo.Builder unused10 = a5.setLongLived(this.mIsLongLived);
        } else {
            ShortcutInfo.Builder unused11 = a5.setExtras(buildLegacyExtrasBundle());
        }
        if (Build.VERSION.SDK_INT >= 33) {
            Api33Impl.setExcludedFromSurfaces(a5, this.mExcludedSurfaces);
        }
        return a5.build();
    }
