...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAction(@NonNull String str) {
            ...
            allowAction((Predicate<String>) new d(str));
            return this;
        }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory((Predicate<String>) new d(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new j(str));
        }
        ...
        public Builder allowComponent(@NonNull ComponentName componentName) {
            ...
            return allowComponent((Predicate<ComponentName>) new h(componentName));
        }
        ...
        public Builder allowComponentWithPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowComponent((Predicate<ComponentName>) new e(str));
        }
        ...
        public Builder allowExtraOutput(@NonNull String str) {
            allowExtra("output", Uri.class, new c(str));
            return this;
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new l(str));
            return this;
        }
        ...
        public Builder allowPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage((Predicate<String>) new d(str));
        }
        ...
        public Builder allowType(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType((Predicate<String>) new d(str));
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull Class<T> cls, @NonNull Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, (Predicate<Object>) new g(cls, predicate));
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0012: CONSTRUCTOR  (r0v5 ? I:androidx.core.content.k) =  call: androidx.core.content.k.<init>():void type: CONSTRUCTOR in method: androidx.core.content.IntentSanitizer.Builder.allowExtra(java.lang.String, androidx.core.util.Predicate):androidx.core.content.IntentSanitizer$Builder, dex: classes.dex
                ...
                /*
                    ...
                    androidx.core.content.k r0 = new androidx.core.content.k
                    r0.<init>()
                L_0x0015:
