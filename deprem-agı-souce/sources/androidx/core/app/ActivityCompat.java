...
public class ActivityCompat extends ContextCompat {
    ...
    static class Api28Impl {
        ...
        static <T> T requireViewById(Activity activity, int i5) {
            return activity.requireViewById(i5);
        }
    }
    ...
    public static boolean isLaunchedFromBubble(@NonNull Activity activity) {
        ...
        if (i5 == 30) {
            ...
            return true;
        } else if (i5 != 29 || activity.getWindowManager().getDefaultDisplay() == null || activity.getWindowManager().getDefaultDisplay().getDisplayId() == 0) {
            return false;
        } else {
            return true;
        }
    ...
    public static <T extends View> T requireViewById(@NonNull Activity activity, @IdRes int i5) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (View) Api28Impl.requireViewById(activity, i5);
        }
        T findViewById = activity.findViewById(i5);
