...
public class ViewCompat {
    ...
    static abstract class AccessibilityViewProperty<T> {
        ...
        /* access modifiers changed from: package-private */
        public boolean shouldUpdate(T t5, T t6) {
            return !t6.equals(t5);
        }
    ...
    static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            I i6 = new I(onUnhandledKeyEventListenerCompat);
            simpleArrayMap.put(onUnhandledKeyEventListenerCompat, i6);
            view.addOnUnhandledKeyEventListener(i6);
        }
    ...
    public static <T extends View> T requireViewById(@NonNull View view, @IdRes int i5) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (View) Api28Impl.requireViewById(view, i5);
        }
        T findViewById = view.findViewById(i5);
    ...
    public static void saveAttributeDataForStyleable(@NonNull View view, @SuppressLint({"ContextFirst"}) @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i5, int i6) {
        if (Build.VERSION.SDK_INT >= 29) {
    ...
    public static void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean z4) {
        ...
        try {
            sChildrenDrawingOrderMethod.invoke(viewGroup, new Object[]{Boolean.valueOf(z4)});
    ...
    public static void setPointerIcon(@NonNull View view, @Nullable PointerIconCompat pointerIconCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Api24Impl.setPointerIcon(view, G.a(obj));
        }
    }
    ...
    public static boolean startDragAndDrop(@NonNull View view, @Nullable ClipData clipData, @NonNull View.DragShadowBuilder dragShadowBuilder, @Nullable Object obj, int i5) {
        ...
        return view.startDrag(clipData, dragShadowBuilder, obj, i5);
    }
    ...
    public static void dispatchNestedScroll(@NonNull View view, int i5, int i6, int i7, int i8, @Nullable int[] iArr, int i9, @NonNull int[] iArr2) {
        ...
        int i12 = i7;
        int i13 = i6;
        dispatchNestedScroll(view, i5, i13, i12, i11, iArr3, i10);
    }
    ...
    public static boolean dispatchNestedScroll(@NonNull View view, int i5, int i6, int i7, int i8, @Nullable int[] iArr, int i9) {
        ...
        int i11 = i7;
        int i12 = i6;
        return dispatchNestedScroll(view, i5, i12, i11, i10, iArr2);
    }
}
