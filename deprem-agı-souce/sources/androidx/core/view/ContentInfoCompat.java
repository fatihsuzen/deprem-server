...
public final class ContentInfoCompat {
    ...
    private static final class Api31Impl {
        ...
        public static Pair<ContentInfo, ContentInfo> partition(@NonNull ContentInfo contentInfo, @NonNull Predicate<ClipData.Item> predicate) {
            ...
            Pair<ClipData, ClipData> partition = ContentInfoCompat.partition(clip, (androidx.core.util.Predicate<ClipData.Item>) new C0331b(predicate));
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(@NonNull ContentInfo contentInfo) {
            this.mWrapped = C0313a.a(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(@NonNull ClipData clipData, int i5) {
            this.mPlatformBuilder = C0345i.a(clipData, i5);
        }
        ...
        public void setFlags(int i5) {
            ContentInfo.Builder unused = this.mPlatformBuilder.setFlags(i5);
        }
        ...
        public void setSource(int i5) {
            ContentInfo.Builder unused = this.mPlatformBuilder.setSource(i5);
        }

        BuilderCompat31Impl(@NonNull ContentInfoCompat contentInfoCompat) {
            C0349k.a();
            this.mPlatformBuilder = C0347j.a(contentInfoCompat.toContentInfo());
        }
    }
