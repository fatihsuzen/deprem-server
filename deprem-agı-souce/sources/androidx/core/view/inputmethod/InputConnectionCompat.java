...
public final class InputConnectionCompat {
    ...
    public static /* synthetic */ boolean a(View view, InputContentInfoCompat inputContentInfoCompat, int i5, Bundle bundle) {
    ...
    public static boolean commitContent(@NonNull InputConnection inputConnection, @NonNull EditorInfo editorInfo, @NonNull InputContentInfoCompat inputContentInfoCompat, int i5, @Nullable Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return Api25Impl.commitContent(inputConnection, c.a(inputContentInfoCompat.unwrap()), i5, bundle);
        }
