...
class DatagramSocketWrapper extends Socket {
    ...
    private static class DatagramSocketImplWrapper extends SocketImpl {
        ...
        /* access modifiers changed from: protected */
        public void bind(InetAddress inetAddress, int i5) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        /* access modifiers changed from: protected */
        public void connect(String str, int i5) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        /* access modifiers changed from: protected */
        public void listen(int i5) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        /* access modifiers changed from: protected */
        public void connect(InetAddress inetAddress, int i5) throws IOException {
            throw new UnsupportedOperationException();
        }
