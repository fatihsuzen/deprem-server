...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            int i5 = 0;
            while (i5 < length) {
                int indexOf = TextUtils.indexOf(charSequence, LINE_FEED, i5, length);
                if (indexOf < 0) {
                    i5 = length;
                } else {
                    i5 = indexOf + 1;
    ...
    public int getParagraphEnd(@IntRange(from = 0) int i5) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            return this.mWrapped.getParagraphEnd(i5);
        }
    ...
    public <T> T[] getSpans(int i5, int i6, Class<T> cls) {
        if (Build.VERSION.SDK_INT >= 29) {
            return this.mWrapped.getSpans(i5, i6, cls);
        }
        return this.mText.getSpans(i5, i6, cls);
    }
    ...
    public static final class Params {
        ...
        Params(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i5, int i6) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = k.a(textPaint).setBreakStrategy(i5).setHyphenationFrequency(i6).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
