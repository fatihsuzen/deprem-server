...
public final class HandlerCompat {
    ...
    private static class Api28Impl {
        ...
        public static boolean postDelayed(Handler handler, Runnable runnable, Object obj, long j5) {
            return handler.postDelayed(runnable, obj, j5);
        }
    ...
    public static Handler createAsync(@NonNull Looper looper) {
        ...
        try {
            ...
            Log.w(TAG, "Unable to invoke Handler(Looper, Callback, boolean) constructor", e5);
    ...
    public static boolean hasCallbacks(@NonNull Handler handler, @NonNull Runnable runnable) {
        ...
        } catch (IllegalAccessException | NoSuchMethodException | NullPointerException e6) {
            throw new UnsupportedOperationException("Failed to call Handler.hasCallbacks(), but there is no safe failure mode for this method. Raising exception.", e6);
        }
    }
