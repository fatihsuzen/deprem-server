...
class TouchResponse {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:61:0x02bb  */
    /* JADX WARNING: Removed duplicated region for block: B:68:0x02ca  */
    /* JADX WARNING: Removed duplicated region for block: B:90:0x0315  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public void scrollMove(float f5, float f6) {
        ...
        float[] fArr = this.mAnchorDpDt;
        if (((double) Math.abs((f8 * fArr[0]) + (this.mTouchDirectionY * fArr[1]))) < 0.01d) {
            float[] fArr2 = this.mAnchorDpDt;
            fArr2[0] = 0.01f;
            fArr2[1] = 0.01f;
        }
