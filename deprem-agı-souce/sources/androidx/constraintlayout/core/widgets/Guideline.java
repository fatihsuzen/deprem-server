...
public class Guideline extends ConstraintWidget {
    ...
    public void inferRelativePercentPosition() {
        float x4 = ((float) getX()) / ((float) getParent().getWidth());
        if (this.mOrientation == 0) {
            x4 = ((float) getY()) / ((float) getParent().getHeight());
        }
        setGuidePercent(x4);
    }
    ...
    public void setGuidePercent(int i5) {
        setGuidePercent(((float) i5) / 100.0f);
    }
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        ...
        if (i5 == 1 || i5 == 2) {
            ...
            return null;
        } else if ((i5 == 3 || i5 == 4) && this.mOrientation == 0) {
            return this.mAnchor;
        } else {
            return null;
        }
