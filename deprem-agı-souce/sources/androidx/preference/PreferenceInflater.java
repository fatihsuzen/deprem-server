...
class PreferenceInflater {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:13:0x0036 A[ExcHandler: Exception (r12v4 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:2:0x000d] */
    ...
    private androidx.preference.Preference createItem(@androidx.annotation.NonNull java.lang.String r11, @androidx.annotation.Nullable java.lang.String[] r12, android.util.AttributeSet r13) throws java.lang.ClassNotFoundException, android.view.InflateException {
        /*
            ...
            android.content.Context r0 = r10.mContext     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            java.lang.ClassLoader r0 = r0.getClassLoader()     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            r3 = 0
            if (r12 == 0) goto L_0x005f
            int r4 = r12.length     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
        ...
        L_0x001e:
            ...
            r8 = r12[r6]     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
        ...
        L_0x003e:
            ...
            android.view.InflateException r12 = new android.view.InflateException     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            ...
            java.lang.String r2 = r13.getPositionDescription()     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            ...
            r0.append(r11)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            java.lang.String r0 = r0.toString()     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            r12.<init>(r0)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            throw r12     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
        L_0x005e:
            throw r7     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
        L_0x005f:
            java.lang.Class r5 = java.lang.Class.forName(r11, r3, r0)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
        L_0x0063:
            java.lang.Class<?>[] r12 = CONSTRUCTOR_SIGNATURE     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            java.lang.reflect.Constructor r0 = r5.getConstructor(r12)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            r0.setAccessible(r2)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            java.util.HashMap<java.lang.String, java.lang.reflect.Constructor<?>> r12 = CONSTRUCTOR_MAP     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            r12.put(r11, r0)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
        L_0x0071:
            java.lang.Object[] r12 = r10.mConstructorArgs     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            r12[r2] = r13     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            java.lang.Object r12 = r0.newInstance(r12)     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            androidx.preference.Preference r12 = (androidx.preference.Preference) r12     // Catch:{ ClassNotFoundException -> 0x003c, Exception -> 0x0036 }
            return r12
        L_0x007c:
    ...
    @NonNull
    public Preference inflate(int i5, @Nullable PreferenceGroup preferenceGroup) {
    ...
    public androidx.preference.Preference inflate(org.xmlpull.v1.XmlPullParser r6, @androidx.annotation.Nullable androidx.preference.PreferenceGroup r7) {
        ...
        L_0x0033:
            ...
            goto L_0x0082
        L_0x0035:
            android.view.InflateException r7 = new android.view.InflateException     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            r1.<init>()     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            java.lang.String r2 = r6.getPositionDescription()     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            r1.append(r2)     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            java.lang.String r2 = ": No start tag found!"
            r1.append(r2)     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            java.lang.String r1 = r1.toString()     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            r7.<init>(r1)     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
            throw r7     // Catch:{ InflateException -> 0x0033, XmlPullParserException -> 0x0031, IOException -> 0x002f }
        L_0x0050:
            android.view.InflateException r1 = new android.view.InflateException     // Catch:{ all -> 0x002d }
            ...
            r2.append(r6)     // Catch:{ all -> 0x002d }
            java.lang.String r6 = ": "
            r2.append(r6)     // Catch:{ all -> 0x002d }
            java.lang.String r6 = r7.getMessage()     // Catch:{ all -> 0x002d }
            r2.append(r6)     // Catch:{ all -> 0x002d }
            java.lang.String r6 = r2.toString()     // Catch:{ all -> 0x002d }
            r1.<init>(r6)     // Catch:{ all -> 0x002d }
            r1.initCause(r7)     // Catch:{ all -> 0x002d }
            throw r1     // Catch:{ all -> 0x002d }
        L_0x0075:
            android.view.InflateException r7 = new android.view.InflateException     // Catch:{ all -> 0x002d }
            java.lang.String r1 = r6.getMessage()     // Catch:{ all -> 0x002d }
            r7.<init>(r1)     // Catch:{ all -> 0x002d }
            r7.initCause(r6)     // Catch:{ all -> 0x002d }
