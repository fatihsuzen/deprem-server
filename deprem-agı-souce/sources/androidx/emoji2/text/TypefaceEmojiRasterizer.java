...
public class TypefaceEmojiRasterizer {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    TypefaceEmojiRasterizer(@NonNull MetadataRepo metadataRepo, @IntRange(from = 0) int i5) {
    ...
    public void draw(@NonNull Canvas canvas, float f5, float f6, @NonNull Paint paint) {
        ...
        Paint paint2 = paint;
        canvas2.drawText(this.mMetadataRepo.getEmojiCharArray(), this.mIndex * 2, 2, f5, f6, paint2);
