...
public class EmojiCompat {
    ...
    private static class CompatInternal {
        ...
        /* access modifiers changed from: package-private */
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i5, @IntRange(from = 0) int i6, @IntRange(from = 0) int i7, boolean z4) {
            return charSequence;
        }
    ...
    public static abstract class Config {
        ...
        public Config setUseEmojiAsDefaultStyle(boolean z4, @Nullable List<Integer> list) {
            ...
            for (Integer intValue : list) {
                this.mEmojiAsDefaultStyleExceptions[i5] = intValue.intValue();
                i5++;
            }
    ...
    private static class ListenerDispatcher implements Runnable {
        ...
        ListenerDispatcher(@NonNull InitCallback initCallback, int i5) {
            this(Arrays.asList(new InitCallback[]{(InitCallback) Preconditions.checkNotNull(initCallback, "initCallback cannot be null")}), i5, (Throwable) null);
        }
        ...
        ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i5) {
            this(collection, i5, (Throwable) null);
        }
