...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        ...
        public Builder setFields(int i5, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i5, (Field) builder.build());
            return this;
        }

        public Builder setOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i5, (Option) builder.build());
            return this;
        }
        ...
        public Builder addFields(int i5, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i5, (Field) builder.build());
            return this;
        }

        public Builder addOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i5, (Option) builder.build());
            return this;
        }
    }
