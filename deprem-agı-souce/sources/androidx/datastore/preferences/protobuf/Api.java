...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        ...
        public Builder setMethods(int i5, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i5, (Method) builder.build());
            return this;
        }

        public Builder setMixins(int i5, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i5, (Mixin) builder.build());
            return this;
        }

        public Builder setOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i5, (Option) builder.build());
            return this;
        }
        ...
        public Builder addMethods(int i5, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i5, (Method) builder.build());
            return this;
        }

        public Builder addMixins(int i5, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i5, (Mixin) builder.build());
            return this;
        }

        public Builder addOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i5, (Option) builder.build());
            return this;
        }
    }
