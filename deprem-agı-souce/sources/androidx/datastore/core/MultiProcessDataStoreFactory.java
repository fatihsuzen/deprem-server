...
public final class MultiProcessDataStoreFactory {
    ...
    public static /* synthetic */ DataStore create$default(MultiProcessDataStoreFactory multiProcessDataStoreFactory, Storage storage, ReplaceFileCorruptionHandler replaceFileCorruptionHandler, List list, M m5, int i5, Object obj) {
        if ((i5 & 2) != 0) {
        ...
        return multiProcessDataStoreFactory.create(storage, replaceFileCorruptionHandler, list, m5);
    }
    ...
    public static /* synthetic */ DataStore create$default(MultiProcessDataStoreFactory multiProcessDataStoreFactory, Serializer serializer, ReplaceFileCorruptionHandler replaceFileCorruptionHandler, List list, M m5, C2616a aVar, int i5, Object obj) {
        if ((i5 & 2) != 0) {
            replaceFileCorruptionHandler = null;
        }
        if ((i5 & 4) != 0) {
        ...
        return multiProcessDataStoreFactory.create(serializer, replaceFileCorruptionHandler, list, m5, aVar);
    }
    ...
    public final <T> DataStore<T> create(Storage<T> storage, ReplaceFileCorruptionHandler<T> replaceFileCorruptionHandler, List<? extends DataMigration<T>> list, M m5) {
        ...
        t.e(list, "migrations");
        t.e(m5, "scope");
        List d5 = C2250q.d(DataMigrationInitializer.Companion.getInitializer(list));
        CorruptionHandler corruptionHandler = replaceFileCorruptionHandler;
        if (replaceFileCorruptionHandler == null) {
            corruptionHandler = new NoOpCorruptionHandler();
        }
        return new DataStoreImpl(storage, d5, corruptionHandler, m5);
    }
    ...
    public final <T> DataStore<T> create(Serializer<T> serializer, ReplaceFileCorruptionHandler<T> replaceFileCorruptionHandler, List<? extends DataMigration<T>> list, M m5, C2616a aVar) {
        ...
        t.e(m5, "scope");
        t.e(aVar, "produceFile");
        FileStorage fileStorage = new FileStorage(serializer, new MultiProcessDataStoreFactory$create$1(m5), aVar);
        List d5 = C2250q.d(DataMigrationInitializer.Companion.getInitializer(list));
        CorruptionHandler corruptionHandler = replaceFileCorruptionHandler;
        if (replaceFileCorruptionHandler == null) {
            corruptionHandler = new NoOpCorruptionHandler();
        }
        return new DataStoreImpl(fileStorage, d5, corruptionHandler, m5);
    }
}
