...
public final class MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1 extends l implements p {
    ...
    public MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1(MultiProcessCoordinator multiProcessCoordinator, C2308e eVar) {
        super(2, eVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            u.b(obj);
            return b.b(this.this$0.getSharedCounter().incrementAndGetValue());
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }

    public final Object invoke(M m5, C2308e eVar) {
        return ((MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1) create(m5, eVar)).invokeSuspend(J.f19942a);
    }
}
