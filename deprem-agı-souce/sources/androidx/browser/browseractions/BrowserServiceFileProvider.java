...
public final class BrowserServiceFileProvider extends FileProvider {
            ...
            synchronized (BrowserServiceFileProvider.sFileCleanupLock) {
                try {
                    ...
                    if (z4) {
                        ...
                        j5 = (System.currentTimeMillis() - CLEANUP_REQUIRED_TIME_SPAN) + DELETION_FAILED_REATTEMPT_DURATION;
                    }
                    SharedPreferences.Editor edit = sharedPreferences.edit();
                    edit.putLong(BrowserServiceFileProvider.LAST_CLEANUP_TIME_KEY, j5);
                    edit.apply();
                    return null;
                } finally {
                }
    ...
    @NonNull
    public static C1722d loadBitmap(@NonNull final ContentResolver contentResolver, @NonNull final Uri uri) {
