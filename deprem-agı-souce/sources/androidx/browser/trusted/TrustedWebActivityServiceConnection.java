...
public final class TrustedWebActivityServiceConnection {
    ...
    static class CancelNotificationArgs {
        ...
        CancelNotificationArgs(String str, int i5) {
    ...
    static class NotifyNotificationArgs {
        ...
        NotifyNotificationArgs(String str, int i5, Notification notification2, String str2) {
            this.platformTag = str;
            this.platformId = i5;
    ...
    TrustedWebActivityServiceConnection(@NonNull b bVar, @NonNull ComponentName componentName) {
        this.mService = bVar;
    ...
    @Nullable
    private static a wrapCallback(@Nullable final TrustedWebActivityCallback trustedWebActivityCallback) {
    ...
    public void cancel(@NonNull String str, int i5) throws RemoteException {
    ...
    public boolean notify(@NonNull String str, int i5, @NonNull Notification notification, @NonNull String str2) throws RemoteException {
    ...
    public Bundle sendExtraCommand(@NonNull String str, @NonNull Bundle bundle, @Nullable TrustedWebActivityCallback trustedWebActivityCallback) throws RemoteException {
        IBinder iBinder;
        a wrapCallback = wrapCallback(trustedWebActivityCallback);
