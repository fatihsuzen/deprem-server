...
final class AppCompatReceiveContentHelper {
    ...
    static boolean maybeHandleDragEventViaPerformReceiveContent(@NonNull View view, @NonNull DragEvent dragEvent) {
        ...
        if (i5 < 31 && i5 >= 24 && dragEvent.getLocalState() == null && ViewCompat.getOnReceiveContentMimeTypes(view) != null) {
    ...
    static boolean maybeHandleMenuActionViaPerformReceiveContent(@NonNull TextView textView, int i5) {
        ClipData clipData;
        int i6 = 0;
