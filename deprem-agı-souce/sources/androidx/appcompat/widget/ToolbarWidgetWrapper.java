...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationMode(int i5) {
        ...
        if (i5 != i6) {
            ...
            } else if (i6 == 2 && (view = this.mTabView) != null && view.getParent() == (toolbar2 = this.mToolbar)) {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i5, long j5) {
        ...
        return animate.alpha(f5).setDuration(j5).setListener(new ViewPropertyAnimatorListenerAdapter() {
    ...
    public void setNavigationContentDescription(int i5) {
        setNavigationContentDescription((CharSequence) i5 == 0 ? null : getContext().getString(i5));
    }
