...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    private interface SuperCaller {
        ...
        void setLineHeight(int i5, @FloatRange(from = 0.0d) float f5);
    ...
    public void setFirstBaselineToTopHeight(@Px @IntRange(from = 0) int i5) {
    ...
    public void setLastBaselineToBottomHeight(@Px @IntRange(from = 0) int i5) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@Px @IntRange(from = 0) int i5) {
    ...
    public void setLineHeight(int i5, @FloatRange(from = 0.0d) float f5) {
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i5, int i6, int i7, int i8) {
        ...
        Drawable drawable2 = i5 != 0 ? AppCompatResources.getDrawable(context, i5) : null;
        Drawable drawable3 = i6 != 0 ? AppCompatResources.getDrawable(context, i6) : null;
        Drawable drawable4 = i7 != 0 ? AppCompatResources.getDrawable(context, i7) : null;
        if (i8 != 0) {
