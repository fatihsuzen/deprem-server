...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private void animateThumbToCheckedState(boolean z4) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, THUMB_POS, new float[]{f5});
    ...
    private int getThumbOffset() {
        ...
        return (int) ((f5 * ((float) getThumbScrollRange())) + 0.5f);
    }
    ...
    private boolean hitThumb(float f5, float f6) {
        ...
        int i9 = this.mThumbWidth + i8 + rect.left + rect.right + i6;
        int i10 = this.mSwitchBottom + i6;
        if (f5 <= ((float) i8) || f5 >= ((float) i9) || f6 <= ((float) i7) || f6 >= ((float) i10)) {
            return false;
        }
        return true;
    }
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        if (charSequence != null) {
            i5 = (int) Math.ceil((double) Layout.getDesiredWidth(charSequence, textPaint));
        } else {
            i5 = 0;
        }
        int i6 = i5;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (layout != null) {
            ...
            if (drawable2 != null) {
                ...
                i5 = bounds.left + bounds.right;
            } else {
                i5 = getWidth();
            }
            canvas.translate((float) ((i5 / 2) - (layout.getWidth() / 2)), (float) (((i8 + i9) / 2) - (layout.getHeight() / 2)));
            layout.draw(canvas);
        }
    ...
    public void onLayout(boolean z4, int i5, int i6, int i7, int i8) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            i11 = getPaddingLeft() + i9;
            i10 = ((this.mSwitchWidth + i11) - i9) - i15;
        } else {
            i10 = (getWidth() - getPaddingRight()) - i15;
            i11 = (i10 - this.mSwitchWidth) + i9 + i15;
        }
        int gravity = getGravity() & 112;
        if (gravity == 16) {
            i14 = this.mSwitchHeight;
            i13 = (((getPaddingTop() + getHeight()) - getPaddingBottom()) / 2) - (i14 / 2);
        } else if (gravity != 80) {
            i13 = getPaddingTop();
            i14 = this.mSwitchHeight;
        } else {
            i12 = getHeight() - getPaddingBottom();
            i13 = i12 - this.mSwitchHeight;
            this.mSwitchLeft = i11;
            this.mSwitchTop = i13;
            this.mSwitchBottom = i12;
            this.mSwitchRight = i10;
        }
        i12 = i14 + i13;
        this.mSwitchLeft = i11;
        this.mSwitchTop = i13;
    ...
    public void onMeasure(int i5, int i6) {
        ...
        if (drawable != null) {
            drawable.getPadding(rect);
            i8 = (this.mThumbDrawable.getIntrinsicWidth() - rect.left) - rect.right;
        ...
        this.mThumbWidth = Math.max(i9, i8);
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
    ...
    public void setSwitchTypeface(Typeface typeface, int i5) {
        ...
        if (i5 > 0) {
            ...
            int i6 = (~(typeface2 != null ? typeface2.getStyle() : 0)) & i5;
            TextPaint textPaint = this.mTextPaint;
            if ((i6 & 1) != 0) {
                z4 = true;
            }
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        appCompatTextHelper.loadFromAttributes(attributeSet2, i6);
        obtainStyledAttributes.recycle();
        ViewConfiguration viewConfiguration = ViewConfiguration.get(context2);
        this.mTouchSlop = viewConfiguration.getScaledTouchSlop();
        this.mMinFlingVelocity = viewConfiguration.getScaledMinimumFlingVelocity();
        getEmojiTextViewHelper().loadFromAttributes(attributeSet2, i6);
