        ...
        private void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (alertParams.mIsSingleChoice) {
                    i5 = alertController2.mSingleChoiceItemLayout;
                } else {
                    i5 = alertController2.mListItemLayout;
                }
                int i6 = i5;
                if (alertParams.mCursor != null) {
                    listAdapter = new SimpleCursorAdapter(alertParams.mContext, i6, alertParams.mCursor, new String[]{alertParams.mLabelColumn}, new int[]{16908308});
                } else {
                    listAdapter = alertParams.mAdapter;
                    if (listAdapter == null) {
                        listAdapter = new CheckedItemAdapter(alertParams.mContext, i6, 16908308, alertParams.mItems);
                    }
                }
            ...
            if (alertParams.mOnClickListener != null) {
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View view, int i5, long j5) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController2.mDialog, i5, recycleListView.isItemChecked(i5));
                    }
                });
            }
    ...
    private void setupView() {
        ...
        if (!z4) {
            ...
            if (view2 != null) {
                ...
                setScrollIndicators(resolvePanel2, view2, z5 | c5 ? 1 : 0, 3);
            }
        }
