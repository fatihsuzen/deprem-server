...
public class ForceStopRunnable implements Runnable {
    ...
    static void setAlarm(Context context) {
        ...
        PendingIntent pendingIntent = getPendingIntent(context, i5);
    ...
    public boolean isForceStopped() {
        ...
        try {
            ...
            PendingIntent pendingIntent = getPendingIntent(this.mContext, i5);
            if (i6 >= 30) {
                ...
                if (a5 != null && !a5.isEmpty()) {
                    ...
                    for (int i7 = 0; i7 < a5.size(); i7++) {
                        ApplicationExitInfo a6 = j.a(a5.get(i7));
    ...
    public void run() {
        ...
        try {
            ...
            if (i5 >= 3) {
                ...
                long j5 = ((long) i5) * BACKOFF_DURATION_MS;
                Logger logger2 = Logger.get();
                String str3 = TAG;
                logger2.debug(str3, "Retrying after " + j5, e6);
