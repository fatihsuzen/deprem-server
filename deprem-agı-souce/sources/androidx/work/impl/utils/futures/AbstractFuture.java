...
public abstract class AbstractFuture<V> implements C1722d {
    ...
    private static final class Cancellation {
        ...
        Cancellation(boolean z4, Throwable th) {
    ...
    private static final class SetFuture<V> implements Runnable {
        ...
        SetFuture(AbstractFuture<V> abstractFuture, C1722d dVar) {
    ...
    static Object getFutureValue(C1722d dVar) {
        if (dVar instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) dVar).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
