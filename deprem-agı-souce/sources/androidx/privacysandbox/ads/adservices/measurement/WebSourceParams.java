...
public final class WebSourceParams {
    ...
    public static final class Companion {
        ...
        public final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams$ads_adservices_release(List<WebSourceParams> list) {
            ...
            for (WebSourceParams next : list) {
                u.a();
                android.adservices.measurement.WebSourceParams a5 = t.a(next.getRegistrationUri()).setDebugKeyAllowed(next.getDebugKeyAllowed()).build();
    ...
    public boolean equals(Object obj) {
        ...
        if (!t.a(this.registrationUri, webSourceParams.registrationUri) || this.debugKeyAllowed != webSourceParams.debugKeyAllowed) {
            return false;
        }
        return true;
    }
