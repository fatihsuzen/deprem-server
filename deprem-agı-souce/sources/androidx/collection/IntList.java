...
public abstract class IntList {
    ...
    public /* synthetic */ IntList(int i5, C2633k kVar) {
        this(i5);
    }
    ...
    public static /* synthetic */ String joinToString$default(IntList intList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        if (obj == null) {
            ...
            return intList.joinToString(charSequence, charSequence2, charSequence3, i7, charSequence5);
        }
    ...
    public final boolean containsAll(IntList intList) {
        ...
        C2728d l5 = C2729e.l(0, intList._size);
        int c5 = l5.c();
        int f5 = l5.f();
        if (c5 > f5) {
            return true;
        }
        while (contains(intList.get(c5))) {
            if (c5 == f5) {
                return true;
            }
            c5++;
    ...
    public final int elementAtOrElse(@IntRange(from = 0) int i5, l lVar) {
        t.e(lVar, "defaultValue");
        if (i5 < 0 || i5 >= this._size) {
            return ((Number) lVar.invoke(Integer.valueOf(i5))).intValue();
        }
        return this.content[i5];
    }
    ...
    public final <R> R fold(R r5, p pVar) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            r5 = pVar.invoke(r5, Integer.valueOf(iArr[i6]));
        }
        return r5;
    }
    ...
    public final <R> R foldIndexed(R r5, q qVar) {
        ...
        int i5 = this._size;
        for (int i6 = 0; i6 < i5; i6++) {
            r5 = qVar.invoke(Integer.valueOf(i6), r5, Integer.valueOf(iArr[i6]));
        }
        return r5;
    }
    ...
    public final <R> R foldRight(R r5, p pVar) {
        ...
        while (true) {
            ...
            r5 = pVar.invoke(Integer.valueOf(iArr[i5]), r5);
        }
    }
    ...
    public final <R> R foldRightIndexed(R r5, q qVar) {
        ...
        while (true) {
            ...
            r5 = qVar.invoke(Integer.valueOf(i5), Integer.valueOf(iArr[i5]), r5);
        }
    }
    ...
    public final void forEachReversed(l lVar) {
        ...
        while (true) {
            i5--;
            if (-1 < i5) {
                lVar.invoke(Integer.valueOf(iArr[i5]));
            } else {
                return;
            }
        }
    ...
    public final void forEachReversedIndexed(p pVar) {
        ...
        while (true) {
            i5--;
            if (-1 < i5) {
                pVar.invoke(Integer.valueOf(i5), Integer.valueOf(iArr[i5]));
            } else {
                return;
            }
        }
    ...
    public final int indexOfLast(l lVar) {
        ...
        while (true) {
            ...
            if (((Boolean) lVar.invoke(Integer.valueOf(iArr[i5]))).booleanValue()) {
                return i5;
            }
        }
    }
    ...
    public static /* synthetic */ String joinToString$default(IntList intList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, l lVar, int i6, Object obj) {
        if (obj == null) {
            if ((i6 & 1) != 0) {
                charSequence = ", ";
            }
            ...
            while (true) {
                ...
                sb.append((CharSequence) lVar.invoke(Integer.valueOf(i9)));
                i8++;
            }
