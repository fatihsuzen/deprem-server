...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr2[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int a5 = a.a(j5) * ScatterMapKt.MurmurHashC1;
                int i8 = a5 ^ (a5 << 16);
                int findFirstAvailableSlot = mutableLongIntMap.findFirstAvailableSlot(i8 >>> 7);
                long j6 = (long) (i8 & 127);
    ...
    public final int getOrPut(long j5, C2616a aVar) {
    ...
    public final void plusAssign(LongIntMap longIntMap) {
        t.e(longIntMap, TypedValues.TransitionType.S_FROM);
        putAll(longIntMap);
    }
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(Long.valueOf(this.keys[i8]), Integer.valueOf(this.values[i8]))).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public /* synthetic */ MutableLongIntMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
