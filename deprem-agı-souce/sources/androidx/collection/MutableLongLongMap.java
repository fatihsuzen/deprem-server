...
public final class MutableLongLongMap extends LongLongMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr2[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int a5 = a.a(j5) * ScatterMapKt.MurmurHashC1;
                int i8 = a5 ^ (a5 << 16);
                int findFirstAvailableSlot = mutableLongLongMap.findFirstAvailableSlot(i8 >>> 7);
                long j6 = (long) (i8 & 127);
                long[] jArr7 = mutableLongLongMap.metadata;
                int i9 = findFirstAvailableSlot >> 3;
                int i10 = (findFirstAvailableSlot & 7) << 3;
                jArr7[i9] = (jArr7[i9] & (~(255 << i10))) | (j6 << i10);
                ...
                jArr6[findFirstAvailableSlot] = jArr4[i7];
            } else {
                jArr = jArr2;
            }
            i7++;
    ...
    public final long getOrPut(long j5, C2616a aVar) {
    ...
    public final void plusAssign(LongLongMap longLongMap) {
        t.e(longLongMap, TypedValues.TransitionType.S_FROM);
        putAll(longLongMap);
    }
    ...
    public final void putAll(LongLongMap longLongMap) {
        ...
        t.e(longLongMap2, TypedValues.TransitionType.S_FROM);
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(Long.valueOf(this.keys[i8]), Long.valueOf(this.values[i8]))).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public /* synthetic */ MutableLongLongMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
