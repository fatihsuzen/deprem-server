...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    private final class MutableMapWrapper extends ScatterMap<K, V>.MapWrapper implements Map<K, V>, C2677a, j$.util.Map {
        ...
        public V put(K k5, V v5) {
            return MutableScatterMap.this.put(k5, v5);
        }
    ...
    public final V compute(K k5, p pVar) {
        boolean z4;
        Object obj;
        t.e(pVar, "computeBlock");
    ...
    public final int findInsertIndex(K k5) {
        int i5;
        int i6;
        K k6 = k5;
        if (k6 != null) {
    ...
    public final V getOrPut(K k5, C2616a aVar) {
    ...
    public final void plusAssign(s sVar) {
        t.e(sVar, "pair");
        set(sVar.c(), sVar.d());
    }
    ...
    public final V put(K k5, V v5) {
        ...
        V[] vArr = this.values;
        V v6 = vArr[findInsertIndex];
        this.keys[findInsertIndex] = k5;
        vArr[findInsertIndex] = v5;
        return v6;
    }

    public final void putAll(s[] sVarArr) {
        t.e(sVarArr, "pairs");
        for (s sVar : sVarArr) {
            set(sVar.a(), sVar.b());
        }
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(this.keys[i8], this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final void set(K k5, V v5) {
        int findInsertIndex = findInsertIndex(k5);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        }
        this.keys[findInsertIndex] = k5;
        this.values[findInsertIndex] = v5;
    }
    ...
    public /* synthetic */ MutableScatterMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final void plusAssign(s[] sVarArr) {
        t.e(sVarArr, "pairs");
        putAll(sVarArr);
    }
    ...
    public final void plusAssign(Iterable<? extends s> iterable) {
        t.e(iterable, "pairs");
        putAll(iterable);
    }

    public final void putAll(Iterable<? extends s> iterable) {
        t.e(iterable, "pairs");
        for (s sVar : iterable) {
            set(sVar.a(), sVar.b());
        }
    ...
    public final void putAll(C2751e eVar) {
        t.e(eVar, "pairs");
    ...
    public final void plusAssign(ScatterMap<K, V> scatterMap) {
        t.e(scatterMap, TypedValues.TransitionType.S_FROM);
        putAll(scatterMap);
    }
