...
public final class MutableFloatSet extends FloatSet {
    ...
    private final int findAbsoluteInsertIndex(float f5) {
        ...
        while (true) {
            ...
            for (long j8 = (~j7) & (j7 - ScatterMapKt.BitmaskLsb) & -9187201950435737472L; j8 != 0; j8 &= j8 - 1) {
                ...
                if (this.elements[numberOfTrailingZeros] == f5) {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr2[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatSet.findFirstAvailableSlot(i8 >>> 7);
                long j5 = (long) (i8 & 127);
                long[] jArr3 = mutableFloatSet.metadata;
                int i9 = findFirstAvailableSlot >> 3;
                int i10 = (findFirstAvailableSlot & 7) << 3;
                jArr3[i9] = ((~(255 << i10)) & jArr3[i9]) | (j5 << i10);
    ...
    public /* synthetic */ MutableFloatSet(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
