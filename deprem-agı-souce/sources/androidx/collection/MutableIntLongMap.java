...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr2[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int i10 = i9 ^ (i9 << 16);
                int findFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i10 >>> 7);
    ...
    public final long getOrPut(int i5, C2616a aVar) {
    ...
    public final void plusAssign(IntLongMap intLongMap) {
        t.e(intLongMap, TypedValues.TransitionType.S_FROM);
        putAll(intLongMap);
    }
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(Integer.valueOf(this.keys[i8]), Long.valueOf(this.values[i8]))).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public /* synthetic */ MutableIntLongMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
