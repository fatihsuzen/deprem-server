...
public abstract class LongFloatMap {
    ...
    public /* synthetic */ LongFloatMap(C2633k kVar) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        if (obj == null) {
            ...
            return longFloatMap.joinToString(charSequence, charSequence2, charSequence3, i7, charSequence5);
        }
        ...
        while (true) {
            ...
            if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j5) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (!((Boolean) pVar2.invoke(Long.valueOf(jArr[i8]), Float.valueOf(fArr[i8]))).booleanValue()) {
                            return false;
                        }
                    }
                    j5 >>= 8;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            pVar2.invoke(Long.valueOf(jArr[i8]), Float.valueOf(fArr[i8]));
                        }
                        j5 >>= 8;
                    }
                    if (i6 != 8) {
    ...
    public final float getOrElse(long j5, C2616a aVar) {
            ...
            if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j5) < 128) {
                        int i9 = (i5 << 3) + i8;
                        long j6 = jArr[i9];
                        i6 += Float.floatToIntBits(fArr[i9]) ^ a.a(j6);
                    }
                    j5 >>= 8;
                }
                if (i7 != 8) {
        ...
        while (true) {
            ...
            if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j5) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) pVar2.invoke(Long.valueOf(jArr[i9]), Float.valueOf(fArr[i9]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j5 >>= 8;
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j5 & 255) < 128) {
                            ...
                            sb.append((CharSequence) pVar2.invoke(Long.valueOf(j6), Float.valueOf(f5)));
                            i7++;
                        }
                        j5 >>= 8;
                        i10++;
