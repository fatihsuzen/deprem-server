...
final class MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 extends k implements p {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, C2308e eVar) {
        super(2, eVar);
        this.this$0 = mutableScatterMap;
    }

    public final C2308e create(Object obj, C2308e eVar) {
        MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 mutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 = new MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(this.this$0, eVar);
    ...
    public final Object invoke(C2753g gVar, C2308e eVar) {
        return ((MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1) create(gVar, eVar)).invokeSuspend(J.f19942a);
    }
}
