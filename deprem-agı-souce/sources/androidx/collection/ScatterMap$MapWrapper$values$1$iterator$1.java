...
final class ScatterMap$MapWrapper$values$1$iterator$1 extends k implements p {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    ScatterMap$MapWrapper$values$1$iterator$1(ScatterMap<K, V> scatterMap, C2308e eVar) {
        super(2, eVar);
        this.this$0 = scatterMap;
    }

    public final C2308e create(Object obj, C2308e eVar) {
        ScatterMap$MapWrapper$values$1$iterator$1 scatterMap$MapWrapper$values$1$iterator$1 = new ScatterMap$MapWrapper$values$1$iterator$1(this.this$0, eVar);
    ...
    public final Object invoke(C2753g gVar, C2308e eVar) {
        return ((ScatterMap$MapWrapper$values$1$iterator$1) create(gVar, eVar)).invokeSuspend(J.f19942a);
    }
}
