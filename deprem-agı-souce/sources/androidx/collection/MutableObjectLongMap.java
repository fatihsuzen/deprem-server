...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    public final long getOrPut(K k5, C2616a aVar) {
    ...
    public final void plusAssign(ObjectLongMap<K> objectLongMap) {
        t.e(objectLongMap, TypedValues.TransitionType.S_FROM);
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(this.keys[i8], Long.valueOf(this.values[i8]))).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public /* synthetic */ MutableObjectLongMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
