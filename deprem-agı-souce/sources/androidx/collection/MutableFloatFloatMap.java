...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr2[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatFloatMap.findFirstAvailableSlot(i8 >>> 7);
                long j5 = (long) (i8 & 127);
                ...
                fArr4[findFirstAvailableSlot] = fArr2[i7];
            } else {
                jArr = jArr2;
            }
            i7++;
    ...
    public final float getOrPut(float f5, C2616a aVar) {
    ...
    public final void plusAssign(FloatFloatMap floatFloatMap) {
        t.e(floatFloatMap, TypedValues.TransitionType.S_FROM);
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(Float.valueOf(this.keys[i8]), Float.valueOf(this.values[i8]))).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public /* synthetic */ MutableFloatFloatMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
