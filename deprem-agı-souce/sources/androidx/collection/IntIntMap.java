...
public abstract class IntIntMap {
    ...
    public /* synthetic */ IntIntMap(C2633k kVar) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(IntIntMap intIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        if (obj == null) {
            ...
            return intIntMap.joinToString(charSequence, charSequence2, charSequence3, i7, charSequence5);
        }
        ...
        while (true) {
            ...
            if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j5) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (!((Boolean) pVar2.invoke(Integer.valueOf(iArr[i8]), Integer.valueOf(iArr2[i8]))).booleanValue()) {
                            return false;
                        }
                    }
                    j5 >>= 8;
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            pVar2.invoke(Integer.valueOf(iArr[i8]), Integer.valueOf(iArr2[i8]));
                        }
                        j5 >>= 8;
                    }
                    if (i6 != 8) {
    ...
    public final int getOrElse(int i5, C2616a aVar) {
        ...
        while (true) {
            ...
            if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j5) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) pVar2.invoke(Integer.valueOf(iArr[i9]), Integer.valueOf(iArr2[i9]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j5 >>= 8;
                    ...
                    if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (i14 < i13) {
                            if ((j5 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) pVar2.invoke(valueOf, Integer.valueOf(i17)));
                                i10++;
                            } else {
                                jArr2 = jArr3;
                                i7 = i12;
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j5 & 255) < 128) {
                            ...
                            sb.append((CharSequence) pVar2.invoke(Integer.valueOf(i12), Integer.valueOf(i13)));
                            i7++;
                        }
                        j5 >>= 8;
                        i10++;
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i11 < i10) {
                        if ((j5 & 255) < 128) {
                            ...
                            sb.append((CharSequence) pVar2.invoke(Integer.valueOf(i13), Integer.valueOf(i14)));
                            i8++;
                        } else {
                            i6 = i9;
                            int i15 = i5;
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j5 & 255) < 128) {
                            ...
                            i5 = i8;
                            sb.append((CharSequence) pVar2.invoke(valueOf, Integer.valueOf(i13)));
                            i7++;
                        } else {
                            i5 = i8;
                        }
