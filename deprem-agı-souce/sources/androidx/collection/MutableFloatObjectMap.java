...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    private final int findAbsoluteInsertIndex(float f5) {
        int i5;
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr2[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatObjectMap.findFirstAvailableSlot(i8 >>> 7);
                long j5 = (long) (i8 & 127);
    ...
    public final V getOrPut(float f5, C2616a aVar) {
    ...
    public final void plusAssign(FloatObjectMap<V> floatObjectMap) {
        t.e(floatObjectMap, TypedValues.TransitionType.S_FROM);
        putAll(floatObjectMap);
    }

    public final V put(float f5, V v5) {
            ...
            while (true) {
                ...
                if ((((~j5) << 7) & j5 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j5) < 128) {
                            int i8 = (i5 << 3) + i7;
                            if (((Boolean) pVar.invoke(Float.valueOf(this.keys[i8]), this.values[i8])).booleanValue()) {
                                removeValueAt(i8);
                            }
                        }
                        j5 >>= 8;
    ...
    public final void set(float f5, V v5) {
        int findAbsoluteInsertIndex = findAbsoluteInsertIndex(f5);
        this.keys[findAbsoluteInsertIndex] = f5;
    ...
    public /* synthetic */ MutableFloatObjectMap(int i5, int i6, C2633k kVar) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
