...
final class ToContinuation<T> implements Runnable {
    ...
    public ToContinuation(C1722d dVar, C2882l lVar) {
        t.f(dVar, "futureToObserve");
        t.f(lVar, "continuation");
    ...
    public void run() {
        ...
        try {
            ...
            lVar.resumeWith(W2.t.b(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
        } catch (ExecutionException e5) {
            C2882l lVar2 = this.continuation;
            Throwable access$nonNullCause = ListenableFutureKt.nonNullCause(e5);
            t.a aVar2 = W2.t.f19966b;
            lVar2.resumeWith(W2.t.b(u.a(access$nonNullCause)));
        }
    }
}
