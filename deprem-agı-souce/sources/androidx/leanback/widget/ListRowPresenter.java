...
public class ListRowPresenter extends RowPresenter {
    ...
    class ListRowPresenterItemBridgeAdapter extends ItemBridgeAdapter {
        ...
        public void onAddPresenter(Presenter presenter, int i5) {
            this.mRowViewHolder.getGridView().getRecycledViewPool().setMaxRecycledViews(i5, ListRowPresenter.this.getRecycledPoolSize(presenter));
        }
    ...
    public static class ViewHolder extends RowPresenter.ViewHolder {
        ...
        public Presenter.ViewHolder getItemViewHolder(int i5) {
            ItemBridgeAdapter.ViewHolder viewHolder = (ItemBridgeAdapter.ViewHolder) this.mGridView.findViewHolderForAdapterPosition(i5);
            if (viewHolder == null) {
                return null;
            }
    ...
    private void setVerticalPadding(ViewHolder viewHolder) {
        ...
        if (viewHolder.isExpanded()) {
            ...
            if (viewHolder.isSelected()) {
                i7 = sExpandedSelectedRowTopPadding;
            } else {
                i7 = viewHolder.mPaddingTop;
            }
            i5 = i7 - spaceUnderBaseline;
            if (this.mHoverCardPresenterSelector == null) {
                i6 = sExpandedRowNoHovercardBottomPadding;
            } else {
                i6 = viewHolder.mPaddingBottom;
            }
        } else if (viewHolder.isSelected()) {
            i6 = sSelectedRowTopPadding;
            i5 = i6 - viewHolder.mPaddingBottom;
        } else {
            i6 = viewHolder.mPaddingBottom;
            i5 = 0;
        }
        viewHolder.getGridView().setPadding(viewHolder.mPaddingLeft, i5, viewHolder.mPaddingRight, i6);
    }
    ...
    public int getExpandedRowHeight() {
        int i5 = this.mExpandedRowHeight;
        if (i5 != 0) {
            return i5;
        }
    ...
    public void onRowViewExpanded(RowPresenter.ViewHolder viewHolder, boolean z4) {
        ...
        if (getRowHeight() != getExpandedRowHeight()) {
            if (z4) {
                i5 = getExpandedRowHeight();
            } else {
                i5 = getRowHeight();
            }
            viewHolder2.getGridView().setRowHeight(i5);
        }
    ...
    public void onSelectLevelChanged(RowPresenter.ViewHolder viewHolder) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            applySelectLevelToChild(viewHolder2, viewHolder2.mGridView.getChildAt(i5));
        }
    }
    ...
    public void setEntranceTransitionState(RowPresenter.ViewHolder viewHolder, boolean z4) {
        ...
        horizontalGridView.setChildrenVisibility(i5);
    }

    public void setExpandedRowHeight(int i5) {
        this.mExpandedRowHeight = i5;
    }
    ...
    public void setRecycledPoolSize(Presenter presenter, int i5) {
        this.mRecycledPoolSize.put(presenter, Integer.valueOf(i5));
    }
    ...
    public ListRowPresenter(int i5, boolean z4) {
        this.mNumRows = 1;
