...
public class DetailsParallaxDrawable extends CompositeDrawable {
    ...
    public void connect(Context context, DetailsParallax detailsParallax, ParallaxTarget parallaxTarget) {
        ...
        detailsParallax.addEffect(overviewRowTop.atAbsolute(dimensionPixelSize), overviewRowTop.atAbsolute(dimensionPixelSize2)).target(parallaxTarget);
    ...
    public void setSolidColor(@ColorInt int i5) {
        ((ColorDrawable) this.mBottomDrawable).setColor(i5);
    }
