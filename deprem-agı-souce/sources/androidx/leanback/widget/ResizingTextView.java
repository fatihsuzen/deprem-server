...
class ResizingTextView extends TextView {
    ...
    public ResizingTextView(Context context, AttributeSet attributeSet, int i5, int i6) {
        super(context, attributeSet, i5);
        this.mIsResized = false;
        this.mDefaultsInitialized = false;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.lbResizingTextView, i5, i6);
        try {
    ...
    private void setPaddingTopAndBottom(int i5, int i6) {
    ...
    public void setMaintainLineSpacing(boolean z4) {
        if (this.mMaintainLineSpacing != z4) {
            this.mMaintainLineSpacing = z4;
            resizeParamsChanged();
        }
    }

    public void setResizedPaddingAdjustmentBottom(int i5) {
        if (this.mResizedPaddingAdjustmentBottom != i5) {
            this.mResizedPaddingAdjustmentBottom = i5;
            resizeParamsChanged();
        }
    }

    public void setResizedPaddingAdjustmentTop(int i5) {
        if (this.mResizedPaddingAdjustmentTop != i5) {
            this.mResizedPaddingAdjustmentTop = i5;
            resizeParamsChanged();
        }
    }

    public void setResizedTextSize(int i5) {
        if (this.mResizedTextSize != i5) {
            this.mResizedTextSize = i5;
            resizeParamsChanged();
        }
    }

    public void setTriggerConditions(int i5) {
        if (this.mTriggerConditions != i5) {
            this.mTriggerConditions = i5;
            requestLayout();
        }
    }

    public ResizingTextView(Context context, AttributeSet attributeSet, int i5) {
