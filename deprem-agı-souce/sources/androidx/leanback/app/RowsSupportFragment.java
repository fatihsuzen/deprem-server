...
public class RowsSupportFragment extends BaseRowSupportFragment implements BrowseSupportFragment.MainFragmentRowsAdapterProvider, BrowseSupportFragment.MainFragmentAdapterProvider {
    ...
    public static class MainFragmentAdapter extends BrowseSupportFragment.MainFragmentAdapter<RowsSupportFragment> {
        ...
        public void setAlignment(int i5) {
            ((RowsSupportFragment) getFragment()).setAlignment(i5);
        }
    ...
    public static class MainFragmentRowsAdapter extends BrowseSupportFragment.MainFragmentRowsAdapter<RowsSupportFragment> {
        ...
        public RowPresenter.ViewHolder findRowViewHolderByPosition(int i5) {
            return ((RowsSupportFragment) getFragment()).findRowViewHolderByPosition(i5);
        }
        ...
        public void setSelectedPosition(int i5, boolean z4, Presenter.ViewHolderTask viewHolderTask) {
            ((RowsSupportFragment) getFragment()).setSelectedPosition(i5, z4, viewHolderTask);
        }

        public void setSelectedPosition(int i5, boolean z4) {
            ((RowsSupportFragment) getFragment()).setSelectedPosition(i5, z4);
        }
    }
