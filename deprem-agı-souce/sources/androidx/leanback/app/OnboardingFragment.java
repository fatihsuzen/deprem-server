...
public abstract class OnboardingFragment extends Fragment {
    ...
    private void onPageChangedInternal(int i5) {
        ...
        if (i5 < getCurrentPageIndex()) {
            ...
            arrayList.add(onboardingFragment.createAnimator(this.mTitleView, false, GravityCompat.START, 0));
            animator = onboardingFragment.createAnimator(onboardingFragment.mDescriptionView, false, GravityCompat.START, DESCRIPTION_START_DELAY_MS);
            ...
            arrayList.add(onboardingFragment.createAnimator(onboardingFragment.mDescriptionView, true, GravityCompat.END, 533));
        } else {
            onboardingFragment = this;
            arrayList.add(onboardingFragment.createAnimator(onboardingFragment.mTitleView, false, GravityCompat.END, 0));
            animator = onboardingFragment.createAnimator(onboardingFragment.mDescriptionView, false, GravityCompat.END, DESCRIPTION_START_DELAY_MS);
            arrayList.add(animator);
            ...
            arrayList.add(onboardingFragment.createAnimator(onboardingFragment.mDescriptionView, true, GravityCompat.START, 533));
        }
        ...
        if (getCurrentPageIndex() == getPageCount() - 1) {
            ...
            loadAnimator.setTarget(onboardingFragment.mPageIndicator);
            ...
            loadAnimator2.setTarget(onboardingFragment.mStartButton);
            ...
            loadAnimator3.setTarget(onboardingFragment.mPageIndicator);
            arrayList.add(loadAnimator3);
            Animator loadAnimator4 = AnimatorInflater.loadAnimator(context, R.animator.lb_onboarding_start_button_fade_out);
            loadAnimator4.setTarget(onboardingFragment.mStartButton);
        ...
        onPageChanged(onboardingFragment.mCurrentPageIndex, i5);
    }
