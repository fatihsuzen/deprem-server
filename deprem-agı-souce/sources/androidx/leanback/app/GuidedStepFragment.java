...
public class GuidedStepFragment extends Fragment implements GuidedActionAdapter.FocusListener {
    ...
    public static int addAsRoot(Activity activity, GuidedStepFragment guidedStepFragment, int i5) {
        ...
        return beginTransaction.replace(i5, guidedStepFragment, TAG_LEAN_BACK_ACTIONS_FRAGMENT).commit();
    }
    ...
    public void popBackStackToGuidedStepFragment(Class<?> cls, int i5) {
    ...
    public static int add(FragmentManager fragmentManager, GuidedStepFragment guidedStepFragment, int i5) {
        GuidedStepFragment currentGuidedStepFragment = getCurrentGuidedStepFragment(fragmentManager);
