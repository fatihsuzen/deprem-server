...
public class VerticalGridSupportFragment extends BaseSupportFragment {
    ...
    private final OnChildLaidOutListener mChildLaidOutListener = new OnChildLaidOutListener() {
        public void onChildLaidOut(ViewGroup viewGroup, View view, int i5, long j5) {
            if (i5 == 0) {
    ...
    /* access modifiers changed from: package-private */
    public void gridOnItemSelected(int i5) {
    ...
    public void setSelectedPosition(int i5) {
        ...
        if (viewHolder != null && viewHolder.getGridView().getAdapter() != null) {
            this.mGridViewHolder.getGridView().setSelectedPositionSmooth(i5);
        }
    }
