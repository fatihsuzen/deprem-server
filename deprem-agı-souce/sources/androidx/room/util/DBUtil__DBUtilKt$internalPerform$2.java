...
@f(c = "androidx.room.util.DBUtil__DBUtilKt$internalPerform$2", f = "DBUtil.kt", l = {56, 57, 59, 60, 65}, m = "invokeSuspend")
public final class DBUtil__DBUtilKt$internalPerform$2 extends l implements p {
    ...
    public DBUtil__DBUtilKt$internalPerform$2(boolean z4, boolean z5, RoomDatabase roomDatabase, p pVar, C2308e eVar) {
        super(2, eVar);
    ...
    public final Object invoke(Transactor transactor, C2308e eVar) {
        return ((DBUtil__DBUtilKt$internalPerform$2) create(transactor, eVar)).invokeSuspend(J.f19942a);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:28:0x008b, code lost:
        if (r9.sync$room_runtime_release(r8) == r0) goto L_0x00d6;
     */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r9) {
        ...
        L_0x0092:
            r1 = r9
        L_0x0093:
            androidx.room.util.DBUtil__DBUtilKt$internalPerform$2$result$1 r9 = new androidx.room.util.DBUtil__DBUtilKt$internalPerform$2$result$1
            k3.p r5 = r8.$block
            r6 = 0
            r9.<init>(r5, r6)
            r8.L$0 = r1
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        DBUtil__DBUtilKt$internalPerform$2$result$1 dBUtil__DBUtilKt$internalPerform$2$result$1 = new DBUtil__DBUtilKt$internalPerform$2$result$1(this.$block, (C2308e) null);
        r.c(0);
