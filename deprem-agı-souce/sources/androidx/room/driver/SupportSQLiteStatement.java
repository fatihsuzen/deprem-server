...
public abstract class SupportSQLiteStatement implements SQLiteStatement {
    ...
    private static final class SupportAndroidSQLiteStatement extends SupportSQLiteStatement {
        ...
        public SupportAndroidSQLiteStatement(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
            super(supportSQLiteDatabase, str, (C2633k) null);
            t.e(supportSQLiteDatabase, "db");
            t.e(str, "sql");
        }
        ...
        private final void ensureCursor() {
            if (this.cursor == null) {
                this.cursor = getDb().query((SupportSQLiteQuery) new SupportSQLiteStatement$SupportAndroidSQLiteStatement$ensureCursor$1(this));
            }
        }
    ...
    public /* synthetic */ SupportSQLiteStatement(SupportSQLiteDatabase supportSQLiteDatabase, String str, C2633k kVar) {
