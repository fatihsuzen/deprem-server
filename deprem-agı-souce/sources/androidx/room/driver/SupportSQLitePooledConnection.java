...
final class SupportSQLitePooledConnection implements Transactor, RawConnectionAccessor {
    ...
    private final class SupportSQLiteTransactor<T> implements TransactionScope<T>, RawConnectionAccessor {
        ...
        public <R> Object usePrepared(String str, l lVar, C2308e eVar) {
            return SupportSQLitePooledConnection.this.usePrepared(str, lVar, eVar);
        }
        ...
        public <R> Object withNestedTransaction(p pVar, C2308e eVar) {
            ...
            Transactor.SQLiteTransactionType access$getCurrentTransactionType$p = supportSQLitePooledConnection.currentTransactionType;
            if (access$getCurrentTransactionType$p != null) {
                return supportSQLitePooledConnection.transaction(access$getCurrentTransactionType$p, pVar, eVar);
            }
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            L_0x0022:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.room.driver.SupportSQLitePooledConnection.WhenMappings.<clinit>():void");
        }
    }

    public SupportSQLitePooledConnection(SupportSQLiteConnection supportSQLiteConnection) {
        t.e(supportSQLiteConnection, "delegate");
    ...
    public final <R> java.lang.Object transaction(androidx.room.Transactor.SQLiteTransactionType r6, k3.p r7, b3.C2308e r8) {
        ...
        L_0x0072:
            androidx.room.driver.SupportSQLitePooledConnection$SupportSQLiteTransactor r6 = new androidx.room.driver.SupportSQLitePooledConnection$SupportSQLiteTransactor     // Catch:{ RollbackException -> 0x009d, all -> 0x0097 }
        ...
        L_0x00bd:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.room.driver.SupportSQLitePooledConnection.transaction(androidx.room.Transactor$SQLiteTransactionType, k3.p, b3.e):java.lang.Object");
    }
    ...
    public <R> java.lang.Object usePrepared(java.lang.String r1, k3.l r2, b3.C2308e r3) {
        /*
            r0 = this;
            androidx.room.driver.SupportSQLiteConnection r3 = r0.delegate
            androidx.room.driver.SupportSQLiteStatement r1 = r3.prepare((java.lang.String) r1)
        ...
        L_0x0011:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.room.driver.SupportSQLitePooledConnection.usePrepared(java.lang.String, k3.l, b3.e):java.lang.Object");
    }
