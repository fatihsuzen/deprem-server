...
public final class N3 extends Z implements U3 {
    public final Spliterator O0(C0483a aVar, Spliterator spliterator) {
        if (Z2.ORDERED.h(aVar.f1653m)) {
            return N0(aVar, spliterator, new C0494c0(24)).spliterator();
        }
        return new Z3((Z) aVar.H0(spliterator), 0);
    }
    ...
    public final C0546m2 Q0(int i5, C0546m2 m2Var) {
        return new M3(this, m2Var, false);
    }

    public final V3 h(C0608z0 z0Var, boolean z4) {
        return new M3(this, z0Var, z4);
    }
}
