...
public final class E2 extends C0602y {

    /* renamed from: s  reason: collision with root package name */
    public final /* synthetic */ int f1469s;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public /* synthetic */ E2(C0483a aVar, int i5, int i6) {
        super(aVar, i5);
        this.f1469s = i6;
    }
        ...
        switch (this.f1469s) {
            case 1:
                if (Z2.ORDERED.h(aVar.f1653m)) {
                    return N0(aVar, spliterator, new C0494c0(27)).spliterator();
                }
                return new Y3((W) aVar.H0(spliterator), 1);
            default:
    ...
    public final H0 N0(C0594w1 w1Var, Spliterator spliterator, IntFunction intFunction) {
        switch (this.f1469s) {
            case 0:
                ...
                double[] dArr = (double[]) ((B0) w1Var.j0(spliterator, true, intFunction)).b();
                Arrays.sort(dArr);
                return new T0(dArr);
            default:
    ...
    public final C0546m2 Q0(int i5, C0546m2 m2Var) {
        switch (this.f1469s) {
            case 0:
                ...
                return Z2.SIZED.h(i5) ? new C0511f2(m2Var) : new C0511f2(m2Var);
            default:
