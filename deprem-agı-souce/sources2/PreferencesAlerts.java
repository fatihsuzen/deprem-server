...
public class PreferencesAlerts extends C0768d {

    public static class MyPreferenceFragment extends PreferenceFragmentCompat {
        /* access modifiers changed from: private */

        /* renamed from: w0  reason: collision with root package name */
        public TextToSpeech f13438w0;

        /* renamed from: x0  reason: collision with root package name */
        private final int f13439x0 = 1000;

        /* renamed from: y0  reason: collision with root package name */
        private boolean f13440y0 = false;

        /* renamed from: z0  reason: collision with root package name */
        private boolean f13441z0 = false;
        ...
        class a extends UtteranceProgressListener {
            ...
            public void onDone(String str) {
                if (MyPreferenceFragment.this.f13438w0 != null) {
                    MyPreferenceFragment.this.f13438w0.stop();
                    MyPreferenceFragment.this.f13438w0.shutdown();
                }
            }
        ...
        public static /* synthetic */ boolean K0(MyPreferenceFragment myPreferenceFragment, Activity activity, Preference preference) {
            if (!myPreferenceFragment.f13440y0 && activity != null) {
                SharedPreferences.Editor edit = g.b(activity).edit();
                edit.putBoolean("eqn_tts_eqn", false);
                edit.apply();
                Preference a8 = myPreferenceFragment.v0().a("eqn_tts_eqn");
                if (a8 != null) {
        ...
        public static /* synthetic */ boolean L0(MyPreferenceFragment myPreferenceFragment, Preference preference) {
        ...
        public static /* synthetic */ void M0(MyPreferenceFragment myPreferenceFragment, int i8) {
            if (i8 != -1) {
                myPreferenceFragment.f13438w0.setSpeechRate(1.0f);
                myPreferenceFragment.f13438w0.speak(myPreferenceFragment.getString(C2030R.string.options_tts_test_network), 0, (Bundle) null, "tts");
                return;
            }
            myPreferenceFragment.getClass();
        }

        public static /* synthetic */ boolean N0(Activity activity, Preference preference) {
        ...
        public static /* synthetic */ boolean O0(MyPreferenceFragment myPreferenceFragment, Preference preference) {
            AudioManager audioManager;
            C0891s activity = myPreferenceFragment.getActivity();
            if (!(activity == null || (audioManager = (AudioManager) activity.getSystemService("audio")) == null)) {
        ...
        public static /* synthetic */ void P0(MyPreferenceFragment myPreferenceFragment, int i8) {
            if (i8 != -1) {
                myPreferenceFragment.f13441z0 = false;
                String string = myPreferenceFragment.getString(C2030R.string.current_language);
                if (string.equals("eng")) {
                    int language = myPreferenceFragment.f13438w0.setLanguage(Locale.ENGLISH);
                    if (language == -1 || language == -2) {
                        ...
                        myPreferenceFragment.f13441z0 = true;
                    }
                }
                if (string.equals("ita")) {
                    int language2 = myPreferenceFragment.f13438w0.setLanguage(Locale.ITALIAN);
                ...
                if (string.equals("es")) {
                    int language3 = myPreferenceFragment.f13438w0.setLanguage(new Locale("es"));
                ...
                if (string.equals("fr")) {
                    int language4 = myPreferenceFragment.f13438w0.setLanguage(new Locale("fr"));
                ...
                if (string.equals("el")) {
                    int language5 = myPreferenceFragment.f13438w0.setLanguage(new Locale("el"));
                ...
                if (string.equals("tr")) {
                    int language6 = myPreferenceFragment.f13438w0.setLanguage(new Locale("tr"));
                ...
                if (string.equals("in")) {
                    int language7 = myPreferenceFragment.f13438w0.setLanguage(new Locale("in"));
                ...
                if (string.equals("hr")) {
                    int language8 = myPreferenceFragment.f13438w0.setLanguage(new Locale("hr"));
                ...
                if (string.equals("ar")) {
                    int language9 = myPreferenceFragment.f13438w0.setLanguage(new Locale("ar"));
                ...
                if (myPreferenceFragment.f13441z0) {
                    TextToSpeech textToSpeech = new TextToSpeech(myPreferenceFragment.getActivity(), new C1863s3(myPreferenceFragment));
                    myPreferenceFragment.f13438w0 = textToSpeech;
        ...
        public static /* synthetic */ boolean Q0(MyPreferenceFragment myPreferenceFragment, Preference preference) {
            ...
            if (notificationManager == null || (a8 = notificationManager.getNotificationChannel(myPreferenceFragment.getString(C2030R.string.channel_realtime))) == null) {
                return true;
            }
        ...
        public void A0(Bundle bundle, String str) {
            Preference a8;
            I0(C2030R.xml.preferences_alerts, str);
            C0891s activity = getActivity();
            if (activity != null) {
                this.f13440y0 = activity.getSharedPreferences(MainActivity.class.getSimpleName(), 0).getBoolean("pro_features", false);
            }
            Preference a9 = v0().a("eqn_notify_channel_change_settings");
            if (a9 != null && Build.VERSION.SDK_INT >= 26) {
                a9.v0(new C1827m3(this));
            }
            Preference a10 = v0().a("eqn_alarm_volume");
            if (a10 != null) {
                a10.v0(new C1833n3(this));
            }
            Preference a11 = v0().a("eqn_tts_eqn");
            if (a11 != null) {
                a11.v0(new C1839o3(this, activity));
            }
            Preference a12 = v0().a("eqn_tts_test_eqn");
            if (a12 != null) {
                a12.v0(new C1845p3(this));
            }
            Preference a13 = v0().a("eqn_tts_volume_eqn");
            if (a13 != null) {
                a13.v0(new C1851q3(activity));
            }
        ...
        public void onActivityResult(int i8, int i9, Intent intent) {
            ...
            if (i9 == 1) {
                this.f13438w0 = new TextToSpeech(getActivity(), new C1857r3(this));
                return;
            }
            try {
